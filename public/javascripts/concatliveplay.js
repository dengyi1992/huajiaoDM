!function (e, t) {
    ...
    e.fromInt = function (r, n) {
        var o, s;
        return n ? (r >>>= 0, r >= 0 && 256 > r && (s = i[r]) ? s : (o = new e(r, 0 > (0 | r) ? -1 : 0, !0), r >= 0 && 256 > r && (i[r] = o), o)) : (r = 0 | r, r >= -128 && 128 > r && (s = t[r]) ? s : (o = new e(r, 0 > r ? -1 : 0, !1), r >= -128 && 128 > r && (t[r] = o), o))
    }, e.fromNumber = function (t, i) {
        return i = !!i, isNaN(t) || !isFinite(t) ? e.ZERO : !i && -s >= t ? e.MIN_VALUE : !i && t + 1 >= s ? e.MAX_VALUE : i && t >= o ? e.MAX_UNSIGNED_VALUE : 0 > t ? e.fromNumber(-t, i).negate() : new e(t % n | 0, t / n | 0, i)
        ...
        if ("number" == typeof i && (r = i, i = !1), r = r || 10, 2 > r || r > 36)throw Error("radix out of range: " + r);
        var n;
        if ((n = t.indexOf("-")) > 0)throw Error('number format error: interior "-" character: ' + t);
        if (0 === n)return e.fromString(t.substring(1), i, r).negate();
        for (var o = e.fromNumber(Math.pow(r, 8)), s = e.ZERO, a = 0; a < t.length; a += 8) {
            var l = Math.min(8, t.length - a), f = parseInt(t.substring(a, a + l), r);
            if (8 > l) {
                var u = e.fromNumber(Math.pow(r, l));
                s = s.multiply(u).add(e.fromNumber(f))
            } else s = s.multiply(o), s = s.add(e.fromNumber(f))
        }
        return s.unsigned = i, s
    ...
    var r = 1 << 24, n = 4294967296, o = 0x10000000000000000, s = o / 2, a = e.fromInt(r);
    return e.ZERO = e.fromInt(0), e.UZERO = e.fromInt(0, !0), e.ONE = e.fromInt(1), e.UONE = e.fromInt(1, !0), e.NEG_ONE = e.fromInt(-1), e.MAX_VALUE = e.fromBits(-1, 2147483647, !1), e.MAX_UNSIGNED_VALUE = e.fromBits(-1, -1, !0), e.MIN_VALUE = e.fromBits(0, -2147483648, !1), e.prototype.toInt = function () {
        ...
        if (this.isNegative()) {
            if (this.equals(e.MIN_VALUE)) {
                var r = e.fromNumber(t), n = this.div(r);
        ...
        i = this;
        for (var s = ""; ;) {
            var a = i.div(o), l = i.subtract(a.multiply(o)).toInt() >>> 0, f = l.toString(t);
            if (i = a, i.isZero())return f + s;
        ...
        return e.isLong(t) || (t = e.fromValue(t)), !this.equals(t)
    }, e.prototype.lessThan = function (t) {
        return e.isLong(t) || (t = e.fromValue(t)), this.compare(t) < 0
        ...
        var i = this.high >>> 16, r = 65535 & this.high, n = this.low >>> 16, o = 65535 & this.low, s = t.high >>> 16, a = 65535 & t.high, l = t.low >>> 16, f = 65535 & t.low, u = 0, h = 0, d = 0, p = 0;
        return p += o + f, d += p >>> 16, p &= 65535, d += n + l, h += d >>> 16, d &= 65535, h += r + a, u += h >>> 16, h &= 65535, u += i + s, u &= 65535, e.fromBits(d << 16 | p, u << 16 | h, this.unsigned)
    }, e.prototype.subtract = function (t) {
        return e.isLong(t) || (t = e.fromValue(t)), this.add(t.negate())
        ...
        var i = this.high >>> 16, r = 65535 & this.high, n = this.low >>> 16, o = 65535 & this.low, s = t.high >>> 16, l = 65535 & t.high, f = t.low >>> 16, u = 65535 & t.low, h = 0, d = 0, p = 0, c = 0;
        return c += o * u, p += c >>> 16, c &= 65535, p += n * u, d += p >>> 16, p &= 65535, p += o * f, d += p >>> 16, p &= 65535, d += r * u, h += d >>> 16, d &= 65535, d += n * f, h += d >>> 16, d &= 65535, d += o * l, h += d >>> 16, d &= 65535, h += i * u + r * f + n * l + o * s, h &= 65535, e.fromBits(p << 16 | c, h << 16 | d, this.unsigned)
    }, e.prototype.div = function (t) {
        if (e.isLong(t) || (t = e.fromValue(t)), t.isZero())throw new Error("division by zero");
        if (this.isZero())return this.unsigned ? e.UZERO : e.ZERO;
        var i, r, n;
        if (this.equals(e.MIN_VALUE)) {
            if (t.equals(e.ONE) || t.equals(e.NEG_ONE))return e.MIN_VALUE;
            if (t.equals(e.MIN_VALUE))return e.ONE;
            var o = this.shiftRight(1);
            return i = o.div(t).shiftLeft(1), i.equals(e.ZERO) ? t.isNegative() ? e.ONE : e.NEG_ONE : (r = this.subtract(t.multiply(i)), n = i.add(r.div(t)))
        }
        ...
        for (n = e.ZERO, r = this; r.greaterThanOrEqual(t);) {
            i = Math.max(1, Math.floor(r.toNumber() / t.toNumber()));
            for (var s = Math.ceil(Math.log(i) / Math.LN2), a = 48 >= s ? 1 : Math.pow(2, s - 48), l = e.fromNumber(i), f = l.multiply(t); f.isNegative() || f.greaterThan(r);)i -= a, l = e.fromNumber(i, this.unsigned), f = l.multiply(t);
            l.isZero() && (l = e.ONE), n = n.add(l), r = r.subtract(f)
        }
        return n
    }, e.prototype.modulo = function (t) {
        return e.isLong(t) || (t = e.fromValue(t)), this.subtract(this.div(t).multiply(t))
        ...
        return e.isLong(t) && (t = t.toInt()), 0 === (t &= 63) ? this : 32 > t ? e.fromBits(this.low << t, this.high << t | this.low >>> 32 - t, this.unsigned) : e.fromBits(0, this.low << t - 32, this.unsigned)
    }, e.prototype.shiftRight = function (t) {
        return e.isLong(t) && (t = t.toInt()), 0 === (t &= 63) ? this : 32 > t ? e.fromBits(this.low >>> t | this.high << 32 - t, this.high >> t, this.unsigned) : e.fromBits(this.high >> t - 32, this.high >= 0 ? 0 : -1, this.unsigned)
    }, e.prototype.shiftRightUnsigned = function (t) {
        if (e.isLong(t) && (t = t.toInt()), t &= 63, 0 === t)return this;
        var i = this.high;
        if (32 > t) {
            var r = this.low;
    ...
    function r(e, t, i, r, n) {
        var o, s, a = 8 * n - r - 1, l = (1 << a) - 1, f = l >> 1, u = -7, h = i ? n - 1 : 0, d = i ? -1 : 1, p = e[t + h];
        for (h += d, o = p & (1 << -u) - 1, p >>= -u, u += a; u > 0; o = 256 * o + e[t + h], h += d, u -= 8);
    ...
    function n(e, t, i, r, n, o) {
        var s, a, l, f = 8 * o - n - 1, u = (1 << f) - 1, h = u >> 1, d = 23 === n ? Math.pow(2, -24) - Math.pow(2, -77) : 0, p = r ? 0 : o - 1, c = r ? 1 : -1, m = 0 > t || 0 === t && 0 > 1 / t ? 1 : 0;
        for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (a = isNaN(t) ? 1 : 0, s = u) : (s = Math.floor(Math.log(t) / Math.LN2), t * (l = Math.pow(2, -s)) < 1 && (s--, l *= 2), t += s + h >= 1 ? d / l : d * Math.pow(2, 1 - h), t * l >= 2 && (s++, l /= 2), s + h >= u ? (a = 0, s = u) : s + h >= 1 ? (a = (t * l - 1) * Math.pow(2, n), s += h) : (a = t * Math.pow(2, h - 1) * Math.pow(2, n), s = 0)); n >= 8; e[i + p] = 255 & a, p += c, a /= 256, n -= 8);
        for (s = s << n | a, f += n; f > 0; e[i + p] = 255 & s, p += c, s /= 256, f -= 8);
        e[i + p - c] |= 128 * m
    }
    ...
    var o = function (e, t, i) {
        ...
        this.buffer = 0 === e ? a : new ArrayBuffer(e), this.view = 0 === e ? null : new Uint8Array(this.buffer), this.offset = 0, this.markedOffset = -1, this.limit = e, this.littleEndian = "undefined" != typeof t && !!t, this.noAssert = !!i
    };
    o.VERSION = "4.0.0", o.LITTLE_ENDIAN = !0, o.BIG_ENDIAN = !1, o.DEFAULT_CAPACITY = 16, o.DEFAULT_ENDIAN = o.BIG_ENDIAN, o.DEFAULT_NOASSERT = !1, o.Long = e || null;
    var s = o.prototype;
    s.__isByteBuffer__, Object.defineProperty(s, "__isByteBuffer__", {value: !0, enumerable: !1, configurable: !1});
    var a = new ArrayBuffer(0), l = String.fromCharCode;
    o.accessor = function () {
        return Uint8Array
        ...
        for (var n, s = 0, a = 0, l = e.length; l > a; ++a)o.isByteBuffer(e[a]) || (e[a] = o.wrap(e[a], t)), n = e[a].limit - e[a].offset, n > 0 && (s += n);
        if (0 === s)return new o(0, i, r);
        var f, u = new o(s, i, r);
        for (a = 0; l > a;)f = e[a++], n = f.limit - f.offset, 0 >= n || (u.view.set(f.view.subarray(f.offset, f.limit), u.offset), u.offset += n);
        ...
        var n;
        if (o.isByteBuffer(e))return n = s.clone.call(e), n.markedOffset = -1, n;
        if (e instanceof Uint8Array)n = new o(0, i, r), e.length > 0 && (n.buffer = e.buffer, n.offset = e.byteOffset, n.limit = e.byteOffset + e.byteLength, n.view = new Uint8Array(e.buffer)); else if (e instanceof ArrayBuffer)n = new o(0, i, r), e.byteLength > 0 && (n.buffer = e, n.offset = 0, n.limit = e.byteLength, n.view = e.byteLength > 0 ? new Uint8Array(e) : null); else {
            ...
            for (var a = 0; a < e.length; ++a)n.view[a] = e[a]
        }
        return n
        ...
        return this.littleEndian ? (this.view[i + 3] = o >>> 24 & 255, this.view[i + 2] = o >>> 16 & 255, this.view[i + 1] = o >>> 8 & 255, this.view[i] = 255 & o, i += 4, this.view[i + 3] = s >>> 24 & 255, this.view[i + 2] = s >>> 16 & 255, this.view[i + 1] = s >>> 8 & 255, this.view[i] = 255 & s) : (this.view[i] = s >>> 24 & 255, this.view[i + 1] = s >>> 16 & 255, this.view[i + 2] = s >>> 8 & 255, this.view[i + 3] = 255 & s, i += 4, this.view[i] = o >>> 24 & 255, this.view[i + 1] = o >>> 16 & 255, this.view[i + 2] = o >>> 8 & 255, this.view[i + 3] = 255 & o), r && (this.offset += 8), this
        ...
        for (t > s && this.resize((s *= 2) > t ? s : t), t -= n, e >>>= 0; e >= 128;)r = 127 & e | 128, this.view[t++] = r, e >>>= 7;
        ...
        var n = o.calculateVarint64(t), s = t.toInt() >>> 0, a = t.shiftRightUnsigned(28).toInt() >>> 0, l = t.shiftRightUnsigned(56).toInt() >>> 0;
        i += n;
        var f = this.buffer.byteLength;
        switch (i > f && this.resize((f *= 2) > i ? f : i), i -= n, n) {
            case 10:
                this.view[i + 9] = l >>> 7 & 1;
            case 9:
        ...
        var s = this.buffer.byteLength;
        return i > s && this.resize((s *= 2) > i ? s : i), i -= o + 1, u.encodeUTF16toUTF8(t(e), function (e) {
            this.view[i++] = e
        ...
        var s = this.buffer.byteLength;
        if (i > s && this.resize((s *= 2) > i ? s : i), i -= 4 + n, this.littleEndian ? (this.view[i + 3] = n >>> 24 & 255, this.view[i + 2] = n >>> 16 & 255, this.view[i + 1] = n >>> 8 & 255, this.view[i] = 255 & n) : (this.view[i] = n >>> 24 & 255, this.view[i + 1] = n >>> 16 & 255, this.view[i + 2] = n >>> 8 & 255, this.view[i + 3] = 255 & n), i += 4, u.encodeUTF16toUTF8(t(e), function (e) {
                this.view[i++] = e
        ...
        var r, n = 0, o = e;
        this.littleEndian ? (n = this.view[e + 2] << 16, n |= this.view[e + 1] << 8, n |= this.view[e], n += this.view[e + 3] << 24 >>> 0) : (n = this.view[e + 1] << 16, n |= this.view[e + 2] << 8, n |= this.view[e + 3], n += this.view[e] << 24 >>> 0), e += 4;
        var s, a = e + n;
        return u.decodeUTF8toUTF16(function () {
            return a > e ? this.view[e++] : null
        }.bind(this), s = i(), this.noAssert), r = s(), t ? (this.offset = e, r) : {string: r, length: e - o}
    }, o.METRICS_CHARS = "c", o.METRICS_BYTES = "b", s.writeUTF8String = function (e, i) {
        var r = "undefined" == typeof i;
        if (r && (i = this.offset), !this.noAssert) {
            if ("number" != typeof i || i % 1 !== 0)throw TypeError("Illegal offset: " + i + " (not an integer)");
            if (i >>>= 0, 0 > i || i + 0 > this.buffer.byteLength)throw RangeError("Illegal offset: 0 <= " + i + " (+0) <= " + this.buffer.byteLength)
        ...
        var s = this.buffer.byteLength;
        return i > s && this.resize((s *= 2) > i ? s : i), i -= n, u.encodeUTF16toUTF8(t(e), function (e) {
            this.view[i++] = e
        ...
        if (t === o.METRICS_BYTES) {
            ...
            if (u.decodeUTF8toUTF16(function () {
                ...
                }.bind(this), s = i(), this.noAssert), r !== f)throw RangeError("Illegal range: Truncated data, " + r + " == " + f);
            return n ? (this.offset = r, s()) : {string: s(), length: r - l}
        }
        throw TypeError("Unsupported metrics: " + t)
    }, s.readString = s.readUTF8String, s.writeVString = function (e, i) {
        var r = "undefined" == typeof i;
        if (r && (i = this.offset), !this.noAssert) {
            if ("string" != typeof e)throw TypeError("Illegal str: Not a string");
            if ("number" != typeof i || i % 1 !== 0)throw TypeError("Illegal offset: " + i + " (not an integer)");
        ...
        var n, s, a = i;
        n = u.calculateUTF16asUTF8(t(e), this.noAssert)[1], s = o.calculateVarint32(n), i += s + n;
        var l = this.buffer.byteLength;
        if (i > l && this.resize((l *= 2) > i ? l : i), i -= s + n, i += this.writeVarint32(n, i), u.encodeUTF16toUTF8(t(e), function (e) {
                this.view[i++] = e
            }.bind(this)), i !== a + n + s)throw RangeError("Illegal range: Truncated data, " + i + " == " + (i + n + s));
        return r ? (this.offset = i, this) : i - a
        ...
        }.bind(this), a, this.noAssert), r = a(), t ? (this.offset = e, r) : {string: r, length: e - o}
        ...
        i += n;
        var s = this.buffer.byteLength;
        return i > s && this.resize((s *= 2) > i ? s : i), i -= n, this.view.set(e.view.subarray(e.offset, e.limit), i), e.offset += n, r && (this.offset += n), this
        ...
        var i = t - e;
        if (0 === i)return this.buffer = a, this.view = null, this.markedOffset >= 0 && (this.markedOffset -= e), this.offset = 0, this.limit = 0, this;
        ...
        if (t = (s = "undefined" == typeof t) ? e.offset : 0 | t, i = (n = "undefined" == typeof i) ? this.offset : 0 | i, r = "undefined" == typeof r ? this.limit : 0 | r, 0 > t || t > e.buffer.byteLength)throw RangeError("Illegal target range: 0 <= " + t + " <= " + e.buffer.byteLength);
        if (0 > i || r > this.buffer.byteLength)throw RangeError("Illegal source range: 0 <= " + i + " <= " + this.buffer.byteLength);
        var a = r - i;
        return 0 === a ? e : (e.ensureCapacity(t + a), e.view.set(this.view.subarray(i, r), t), n && (this.offset += a), s && (e.offset += a), this)
        ...
        if (s > 0) {
            ...
            l.set(this.view.subarray(i, this.buffer.byteLength), n), this.buffer = a, this.view = l, this.offset += s, this.markedOffset >= 0 && (this.markedOffset += s), this.limit += s, i += s
    ...
    var f = function () {
        ...
        return e.encode = function (e, i) {
            ...
            for (var n, o, s; null !== (n = e());)if (o = i[n], "undefined" == typeof o && r(n), null !== (n = e()) && (s = i[n], "undefined" == typeof s && r(n), t(o << 2 >>> 0 | (48 & s) >> 4), null !== (n = e()))) {
                if (o = i[n], "undefined" == typeof o) {
                    if (61 === n)break;
                    r(n)
                }
                if (t((15 & s) << 4 >>> 0 | (60 & o) >> 2), null !== (n = e())) {
    ...
    s.toBase64 = function (e, t) {
        ...
        var n = new o(e.length / 4 * 3, i, r), s = 0;
        ...
        for (var r, n = 0, s = e.length, a = new o(s, t, i); s > n;) {
            if (r = e.charCodeAt(n), !i && r > 255)throw RangeError("Illegal charCode at " + n + ": 0 <= " + r + " <= 255");
            a.view[n++] = r
        }
        return a.limit = s, a
        ...
        for (var r, n, s = e.length, a = new o((s + 1) / 3 | 0, t, i), l = 0, f = 0, u = !1, h = !1, d = !1, p = !1, c = !1; s > l;) {
            switch (r = e.charAt(l++)) {
                case"!":
                    if (!i) {
                        if (h || d || p) {
                    ...
                    a.offset = a.markedOffset = a.limit = f, u = !1;
                    break;
                case"|":
                    if (!i) {
                        if (h || p) {
                ...
                default:
                    ...
                    if (n = parseInt(r + e.charAt(l++), 16), !i && (isNaN(n) || 0 > n || n > 255))throw TypeError("Illegal str: Not a debug encoded string");
                    a.view[f++] = n, u = !0
            }
        ...
        for (var r, n = e.length, s = new o(n / 2 | 0, t), a = 0, l = 0; n > a; a += 2) {
            if (r = parseInt(e.substring(a, a + 2), 16), !i && (!isFinite(r) || 0 > r || r > 255))throw TypeError("Illegal str: Contains non-hex characters");
            s.view[l++] = r
        }
        return s.limit = l, s
    };
    var u = function () {
        ...
        return e.MAX_CODEPOINT = 1114111, e.encodeUTF8 = function (e, t) {
            ...
            }; null !== (i = e());)if (0 === (128 & i))t(i); else if (192 === (224 & i))null === (r = e()) && s([i, r]), t((31 & i) << 6 | 63 & r); else if (224 === (240 & i))(null === (r = e()) || null === (n = e())) && s([i, r, n]), t((15 & i) << 12 | (63 & r) << 6 | 63 & n); else {
                if (240 !== (248 & i))throw RangeError("Illegal starting byte: " + i);
                (null === (r = e()) || null === (n = e()) || null === (o = e())) && s([i, r, n, o]), t((7 & i) << 18 | (63 & r) << 12 | (63 & n) << 6 | 63 & o)
            }
    ...
    return s.toUTF8 = function (e, t) {
        ...
        var n = new o(u.calculateUTF16asUTF8(t(e), !0)[1], i, r), s = 0;
    ...
    "use strict";
    var t = {};
    return t.ByteBuffer = e, t.Long = e.Long || null, t.VERSION = "4.0.0", t.WIRE_TYPES = {}, t.WIRE_TYPES.VARINT = 0, t.WIRE_TYPES.BITS64 = 1, t.WIRE_TYPES.LDELIM = 2, t.WIRE_TYPES.STARTGROUP = 3, t.WIRE_TYPES.ENDGROUP = 4, t.WIRE_TYPES.BITS32 = 5, t.PACKABLE_WIRE_TYPES = [t.WIRE_TYPES.VARINT, t.WIRE_TYPES.BITS64, t.WIRE_TYPES.BITS32], t.TYPES = {
        int32: {
            name: "int32",
            wireType: t.WIRE_TYPES.VARINT,
            defaultValue: 0
        },
        uint32: {name: "uint32", wireType: t.WIRE_TYPES.VARINT, defaultValue: 0},
        sint32: {name: "sint32", wireType: t.WIRE_TYPES.VARINT, defaultValue: 0},
        int64: {name: "int64", wireType: t.WIRE_TYPES.VARINT, defaultValue: t.Long ? t.Long.ZERO : void 0},
        uint64: {name: "uint64", wireType: t.WIRE_TYPES.VARINT, defaultValue: t.Long ? t.Long.UZERO : void 0},
        sint64: {name: "sint64", wireType: t.WIRE_TYPES.VARINT, defaultValue: t.Long ? t.Long.ZERO : void 0},
        bool: {name: "bool", wireType: t.WIRE_TYPES.VARINT, defaultValue: !1},
        "double": {name: "double", wireType: t.WIRE_TYPES.BITS64, defaultValue: 0},
        string: {name: "string", wireType: t.WIRE_TYPES.LDELIM, defaultValue: ""},
        bytes: {name: "bytes", wireType: t.WIRE_TYPES.LDELIM, defaultValue: null},
        fixed32: {name: "fixed32", wireType: t.WIRE_TYPES.BITS32, defaultValue: 0},
        sfixed32: {name: "sfixed32", wireType: t.WIRE_TYPES.BITS32, defaultValue: 0},
        fixed64: {name: "fixed64", wireType: t.WIRE_TYPES.BITS64, defaultValue: t.Long ? t.Long.UZERO : void 0},
        sfixed64: {name: "sfixed64", wireType: t.WIRE_TYPES.BITS64, defaultValue: t.Long ? t.Long.ZERO : void 0},
        "float": {name: "float", wireType: t.WIRE_TYPES.BITS32, defaultValue: 0},
        "enum": {name: "enum", wireType: t.WIRE_TYPES.VARINT, defaultValue: 0},
        message: {name: "message", wireType: t.WIRE_TYPES.LDELIM, defaultValue: null},
        group: {name: "group", wireType: t.WIRE_TYPES.STARTGROUP, defaultValue: null}
    }, t.MAP_KEY_TYPES = [t.TYPES.int32, t.TYPES.sint32, t.TYPES.sfixed32, t.TYPES.uint32, t.TYPES.fixed32, t.TYPES.int64, t.TYPES.sint64, t.TYPES.sfixed64, t.TYPES.uint64, t.TYPES.fixed64, t.TYPES.bool, t.TYPES.string, t.TYPES.bytes], t.ID_MIN = 1, t.ID_MAX = 536870911, t.convertFieldsToCamelCase = !1, t.populateAccessors = !0, t.populateDefaults = !0, t.Util = function () {
        var e = {};
        return e.IS_NODE = !("object" != typeof process || process + "" != "[object process]"), e.XHR = function () {
            for (var e = [function () {
            ...
            if (i && "function" != typeof i && (i = null), e.IS_NODE)if (i)require("fs").readFile(t, function (e, t) {
                ...
                var n = e.XHR();
                if (n.open("GET", t, !!i), n.setRequestHeader("Accept", "text/plain"), "function" == typeof n.overrideMimeType && n.overrideMimeType("text/plain"), !i)return n.send(null), 200 == n.status || 0 == n.status && "string" == typeof n.responseText ? n.responseText : null;
        ...
        n._readString = function () {
            ...
            if (null !== (e = t.STRING.exec(this.source))) {
                ...
                return this.index = t.STRING.lastIndex, this.stack.push(this.stringEndsWith), i
            }
            ...
            var e, i;
            do {
                for (e = !1; t.WHITESPACE.test(i = this.source.charAt(this.index));)if (this.index++, "\n" === i && this.line++, this.index === this.source.length)return null;
            ...
            if (n)++r; else for (++r; r < this.source.length && !t.DELIM.test(this.source.charAt(r));)r++;
        ...
        return s.parse = function () {
            for (var e, t = {
                ...
                options: {},
                services: []
            }, i = !0; e = this.tn.next();)switch (e) {
                case"package":
                    if (!i || null !== t["package"])throw Error("Unexpected package at line " + this.tn.line);
                    t["package"] = this._parsePackage(e);
                    break;
                case"import":
                    if (!i)throw Error("Unexpected import at line " + this.tn.line);
                    t.imports.push(this._parseImport(e));
                    break;
                case"message":
                    this._parseMessage(t, null, e), i = !1;
                    break;
                case"enum":
                    this._parseEnum(t, e), i = !1;
                    break;
                case"option":
            ...
            if (t.NUMBER_FLT.test(e))return "inf" === e ? i * (1 / 0) : "nan" === e ? NaN : i * parseFloat(e);
            throw Error("Illegal number at line " + this.tn.line + ": " + (0 > i ? "-" : "") + e)
        }, s._parseString = function () {
            var e, i, r = "";
            do {
                if (i = this.tn.next(), r += this.tn.next(), e = this.tn.next(), e !== i)throw Error("Illegal end of string at line " + this.tn.line + ": " + e);
                e = this.tn.peek()
            ...
            if ("-" == e.charAt(0) && (n = -1, e = e.substring(1)), t.NUMBER_DEC.test(e))r = parseInt(e); else if (t.NUMBER_HEX.test(e))r = parseInt(e.substring(2), 16); else {
                if (!t.NUMBER_OCT.test(e))throw Error("Illegal id at line " + this.tn.line + ": " + (0 > n ? "-" : "") + e);
                r = parseInt(e.substring(1), 8)
            }
            if (r = n * r | 0, !i && 0 > r)throw Error("Illegal id at line " + this.tn.line + ": " + (0 > n ? "-" : "") + e);
            return r
            ...
            i = this.tn.next();
            var r = !1;
            if (i == t.COPTOPEN && (r = !0, i = this.tn.next()), !t.TYPEREF.test(i) && !/google\.protobuf\./.test(i))throw Error("Illegal option name in message " + e.name + " at line " + this.tn.line + ": " + i);
            var n = i;
            if (i = this.tn.next(), r) {
                if (i !== t.COPTCLOSE)throw Error("Illegal end in message " + e.name + ", option " + n + " at line " + this.tn.line + ": " + i);
                n = "(" + n + ")", i = this.tn.next(), t.FQTYPEREF.test(i) && (n += i, i = this.tn.next())
            }
            if (i !== t.EQUAL)throw Error("Illegal operator in message " + e.name + ", option " + n + " at line " + this.tn.line + ": " + i);
            var o;
            if (i = this.tn.peek(), i === t.STRINGOPEN || i === t.STRINGOPEN_SQ)o = this._parseString(); else if (this.tn.next(), t.NUMBER.test(i))o = this._parseNumber(i, !0); else if (t.BOOL.test(i))o = "true" === i; else {
                if (!t.TYPEREF.test(i))throw Error("Illegal option value in message " + e.name + ", option " + n + " at line " + this.tn.line + ": " + i);
                o = i
            }
            if (i = this.tn.next(), i !== t.END)throw Error("Illegal end of option in message " + e.name + ", option " + n + " at line " + this.tn.line + ": " + i);
            e.options[n] = o
        }, s._parseIgnoredStatement = function (e, i) {
            for (var r; ;) {
                if (r = this.tn.next(), null === r)throw Error("Unexpected EOF in " + e.name + ", " + i + " at line " + this.tn.line);
                if (r === t.END)break
            }
        }, s._parseService = function (e, i) {
            if (i = this.tn.next(), !t.NAME.test(i))throw Error("Illegal service name at line " + this.tn.line + ": " + i);
            var r = i, n = {name: r, rpc: {}, options: {}};
            if (i = this.tn.next(), i !== t.OPEN)throw Error("Illegal start of service " + r + " at line " + this.tn.line + ": " + i);
            do if (i = this.tn.next(), "option" === i)this._parseOption(n, i); else if ("rpc" === i)this._parseServiceRPC(n, i); else if (i !== t.CLOSE)throw Error("Illegal type of service " + r + " at line " + this.tn.line + ": " + i); while (i !== t.CLOSE);
            e.services.push(n)
        }, s._parseServiceRPC = function (e, i) {
            var r = i;
            if (i = this.tn.next(), !t.NAME.test(i))throw Error("Illegal method name in service " + e.name + " at line " + this.tn.line + ": " + i);
            var n = i, o = {request: null, response: null, request_stream: !1, response_stream: !1, options: {}};
            if (i = this.tn.next(), i !== t.COPTOPEN)throw Error("Illegal start of request type in service " + e.name + "#" + n + " at line " + this.tn.line + ": " + i);
            if (i = this.tn.next(), "stream" === i.toLowerCase() && (o.request_stream = !0, i = this.tn.next()), !t.TYPEREF.test(i))throw Error("Illegal request type in service " + e.name + "#" + n + " at line " + this.tn.line + ": " + i);
            if (o.request = i, i = this.tn.next(), i != t.COPTCLOSE)throw Error("Illegal end of request type in service " + e.name + "#" + n + " at line " + this.tn.line + ": " + i);
            if (i = this.tn.next(), "returns" !== i.toLowerCase())throw Error("Illegal delimiter in service " + e.name + "#" + n + " at line " + this.tn.line + ": " + i);
            if (i = this.tn.next(), i != t.COPTOPEN)throw Error("Illegal start of response type in service " + e.name + "#" + n + " at line " + this.tn.line + ": " + i);
            if (i = this.tn.next(), "stream" === i.toLowerCase() && (o.response_stream = !0, i = this.tn.next()), o.response = i, i = this.tn.next(), i !== t.COPTCLOSE)throw Error("Illegal end of response type in service " + e.name + "#" + n + " at line " + this.tn.line + ": " + i);
            if (i = this.tn.next(), i === t.OPEN) {
                do if (i = this.tn.next(), "option" === i)this._parseOption(o, i); else if (i !== t.CLOSE)throw Error("Illegal start of option inservice " + e.name + "#" + n + " at line " + this.tn.line + ": " + i); while (i !== t.CLOSE);
                this.tn.peek() === t.END && this.tn.next()
            } else if (i !== t.END)throw Error("Illegal delimiter in service " + e.name + "#" + n + " at line " + this.tn.line + ": " + i);
            "undefined" == typeof e[r] && (e[r] = {}), e[r][n] = o
            ...
            if (n.name = r, o) {
                if (r = this.tn.next(), r !== t.EQUAL)throw Error("Illegal id assignment after group " + n.name + " at line " + this.tn.line + ": " + r);
                r = this.tn.next();
                try {
            ...
            if (n.fields = [], n.enums = [], n.messages = [], n.options = {}, n.oneofs = {}, r = this.tn.next(), r === t.OPTOPEN && i && (this._parseFieldOptions(n, i, r), r = this.tn.next()), r !== t.OPEN)throw Error("Illegal start of " + (o ? "group" : "message") + " " + n.name + " at line " + this.tn.line + ": " + r);
            for (; ;) {
                if (r = this.tn.next(), r === t.CLOSE) {
                    r = this.tn.peek(), r === t.END && this.tn.next();
                    break
                }
                if (t.RULE.test(r))this._parseMessageField(n, r); else if ("oneof" === r)this._parseMessageOneOf(n, r); else if ("enum" === r)this._parseEnum(n, r); else if ("message" === r)this._parseMessage(n, null, r); else if ("option" === r)this._parseOption(n, r); else if ("extensions" === r)n.extensions = this._parseExtensions(n, r); else if ("extend" === r)this._parseExtend(n, r); else {
                    if (!t.TYPEREF.test(r))throw Error("Illegal token in message " + n.name + " at line " + this.tn.line + ": " + r);
                    this._parseMessageField(n, "optional", r)
                }
            }
            return e.messages.push(n), n
        }, s._parseMessageField = function (e, i, r) {
            var n = {}, o = null;
            if (n.rule = i, n.options = {}, i = "undefined" != typeof r ? r : this.tn.next(), "map" === n.rule) {
                if (i !== t.LT)throw Error("Illegal token in message " + e.name + " at line " + this.tn.line + ": " + i);
                if (i = this.tn.next(), !t.TYPE.test(i) && !t.TYPEREF.test(i))throw Error("Illegal token in message " + e.name + " at line " + this.tn.line + ": " + i);
                if (n.keytype = i, i = this.tn.next(), i !== t.COMMA)throw Error("Illegal token in message " + e.name + " at line " + this.tn.line + ": " + i);
                if (i = this.tn.next(), !t.TYPE.test(i) && !t.TYPEREF.test(i))throw Error("Illegal token in message " + e.name + " at line " + this.tn.line + ": " + i);
                if (n.type = i, i = this.tn.next(), i !== t.GT)throw Error("Illegal token in message " + e.name + " at line " + this.tn.line + ": " + i);
                if (i = this.tn.next(), !t.NAME.test(i))throw Error("Illegal token in message " + e.name + " at line " + this.tn.line + ": " + i);
                if (n.name = i, i = this.tn.next(), i !== t.EQUAL)throw Error("Illegal token in field " + e.name + "#" + n.name + " at line " + this.line + ": " + i);
                i = this.tn.next();
                try {
                ...
                if (i = this.tn.next(), i === t.OPTOPEN && (this._parseFieldOptions(e, n, i), i = this.tn.next()), i !== t.END)throw Error("Illegal delimiter in message " + e.name + "#" + n.name + " at line " + this.tn.line + ": " + i)
            } else if ("group" === i) {
                if (o = this._parseMessage(e, n, i), !/^[A-Z]/.test(o.name))throw Error("Group names must start with a capital letter");
                n.type = o.name, n.name = o.name.toLowerCase(), i = this.tn.peek(), i === t.END && this.tn.next()
            } else {
                if (!t.TYPE.test(i) && !t.TYPEREF.test(i))throw Error("Illegal field type in message " + e.name + " at line " + this.tn.line + ": " + i);
                if (n.type = i, i = this.tn.next(), !t.NAME.test(i))throw Error("Illegal field name in message " + e.name + " at line " + this.tn.line + ": " + i);
                if (n.name = i, i = this.tn.next(), i !== t.EQUAL)throw Error("Illegal token in field " + e.name + "#" + n.name + " at line " + this.tn.line + ": " + i);
                i = this.tn.next();
                try {
                    n.id = this._parseId(i)
                } catch (s) {
            ...
            return e.fields.push(n), n
        }, s._parseMessageOneOf = function (e, i) {
            if (i = this.tn.next(), !t.NAME.test(i))throw Error("Illegal oneof name in message " + e.name + " at line " + this.tn.line + ": " + i);
            var r, n = i, o = [];
            if (i = this.tn.next(), i !== t.OPEN)throw Error("Illegal start of oneof " + n + " at line " + this.tn.line + ": " + i);
            for (; this.tn.peek() !== t.CLOSE;)r = this._parseMessageField(e, "optional"), r.oneof = n, o.push(r.id);
            this.tn.next(), e.oneofs[n] = o
        }, s._parseFieldOptions = function (e, i, r) {
            for (var n = !0; r = this.tn.next(), r !== t.OPTCLOSE;) {
                if (r === t.OPTEND) {
                    if (n)throw Error("Illegal start of options in message " + e.name + "#" + i.name + " at line " + this.tn.line + ": " + r);
                    r = this.tn.next()
                }
                this._parseFieldOption(e, i, r), n = !1
            }
        }, s._parseFieldOption = function (e, i, r) {
            var n = !1;
            if (r === t.COPTOPEN && (r = this.tn.next(), n = !0), !t.TYPEREF.test(r))throw Error("Illegal field option in " + e.name + "#" + i.name + " at line " + this.tn.line + ": " + r);
            var o = r;
            if (r = this.tn.next(), n) {
                if (r !== t.COPTCLOSE)throw Error("Illegal delimiter in " + e.name + "#" + i.name + " at line " + this.tn.line + ": " + r);
                o = "(" + o + ")", r = this.tn.next(), t.FQTYPEREF.test(r) && (o += r, r = this.tn.next())
            }
            if (r !== t.EQUAL)throw Error("Illegal token in " + e.name + "#" + i.name + " at line " + this.tn.line + ": " + r);
            var s;
            if (r = this.tn.peek(), r === t.STRINGOPEN || r === t.STRINGOPEN_SQ)s = this._parseString(); else if (t.NUMBER.test(r, !0))s = this._parseNumber(this.tn.next(), !0); else if (t.BOOL.test(r))s = "true" === this.tn.next().toLowerCase(); else {
                if (!t.TYPEREF.test(r))throw Error("Illegal value in message " + e.name + "#" + i.name + ", option " + o + " at line " + this.tn.line + ": " + r);
                s = this.tn.next()
            }
            i.options[o] = s
        }, s._parseEnum = function (e, i) {
            var r = {};
            if (i = this.tn.next(), !t.NAME.test(i))throw Error("Illegal enum name in message " + e.name + " at line " + this.tn.line + ": " + i);
            if (r.name = i, i = this.tn.next(), i !== t.OPEN)throw Error("Illegal start of enum " + r.name + " at line " + this.tn.line + ": " + i);
            for (r.values = [], r.options = {}; ;) {
                if (i = this.tn.next(), i === t.CLOSE) {
                    i = this.tn.peek(), i === t.END && this.tn.next();
                    break
                }
                if ("option" == i)this._parseOption(r, i); else {
                    if (!t.NAME.test(i))throw Error("Illegal name in enum " + r.name + " at line " + this.tn.line + ": " + i);
            ...
            var r = {};
            if (r.name = i, i = this.tn.next(), i !== t.EQUAL)throw Error("Illegal token in enum " + e.name + " at line " + this.tn.line + ": " + i);
            i = this.tn.next();
            try {
            ...
            if (e.values.push(r), i = this.tn.next(), i === t.OPTOPEN) {
                var o = {options: {}};
                this._parseFieldOptions(e, o, i), i = this.tn.next()
            }
            if (i !== t.END)throw Error("Illegal delimiter in enum " + e.name + " at line " + this.tn.line + ": " + i)
        }, s._parseExtensions = function (i, r) {
            var n = [];
            if (r = this.tn.next(), "min" === r ? n.push(e.ID_MIN) : "max" === r ? n.push(e.ID_MAX) : n.push(this._parseNumber(r)), r = this.tn.next(), "to" !== r)throw Error("Illegal extensions delimiter in message " + i.name + " at line " + this.tn.line + ": " + r);
            if (r = this.tn.next(), "min" === r ? n.push(e.ID_MIN) : "max" === r ? n.push(e.ID_MAX) : n.push(this._parseNumber(r)), r = this.tn.next(), r !== t.END)throw Error("Illegal extensions delimiter in message " + i.name + " at line " + this.tn.line + ": " + r);
            return n
        }, s._parseExtend = function (e, i) {
            if (i = this.tn.next(), !t.TYPEREF.test(i))throw Error("Illegal message name at line " + this.tn.line + ": " + i);
            var r = {};
            if (r.ref = i, r.fields = [], i = this.tn.next(), i !== t.OPEN)throw Error("Illegal start of extend " + r.name + " at line " + this.tn.line + ": " + i);
            for (; ;) {
                if (i = this.tn.next(), i === t.CLOSE) {
                    i = this.tn.peek(), i == t.END && this.tn.next();
                    break
                }
                if (t.RULE.test(i))this._parseMessageField(r, i); else {
                    if (!t.TYPEREF.test(i))throw Error("Illegal token in extend " + r.name + " at line " + this.tn.line + ": " + i);
            ...
            var i = this.tn.next();
            if (i !== t.EQUAL)throw Error("Illegal token at line " + this.tn.line + ": " + i);
            if (i = this.tn.peek(), i !== t.STRINGOPEN && i !== t.STRINGOPEN_SQ)throw Error("Illegal token at line " + this.tn.line + ": " + i);
            var r = this._parseString();
            if (i = this.tn.next(), i !== t.END)throw Error("Illegal token at line " + this.tn.line + ": " + i);
            return r
        }, s.toString = function () {
            return "Parser"
        }, i.Parser = o, i
        ...
        function n(e, i) {
            var r = i.readVarint32(), o = 7 & r, s = r >>> 3;
            switch (o) {
        ...
        f.getChildren = function (e) {
            ...
            do {
                do {
                    ...
                    if (s = r.getChild(i[n]), !s || !(s instanceof o.T) || t && !(s instanceof o.Namespace)) {
                        r = null;
                        break
                    }
                    r = s, n++
            ...
            for (var e, t = {}, i = this.children, r = 0, n = i.length; n > r; ++r)e = i[r], e instanceof l && (t[e.name] = e.build());
        ...
        var u = function (e, i, r, n) {
            if (this.type = e, this.resolvedType = i, this.isMapKey = r, this.syntax = n, r && t.MAP_KEY_TYPES.indexOf(e) < 0)throw Error("Invalid map key type: " + e.name)
        }, h = u.prototype;
        h.defaultFieldValue = i, h.verifyValue = function (i) {
            var n = function (e, t) {
            ...
            switch (this.type) {
                ...
                case t.TYPES.message:
                    ...
                    if (i instanceof t.Builder.Message) {
                        var a = {};
                        for (var l in i)i.hasOwnProperty(l) && (a[l] = i[l]);
                        i = a
                    }
            ...
            switch (this.type) {
                ...
                case t.TYPES.message:
                    var s = (new e).LE();
                    this.resolvedType.encode(r, s), n.writeVarint32(s.offset), n.append(s.flip());
                    break;
                case t.TYPES.group:
            ...
            switch (this.type) {
                ...
                case t.TYPES.bytes:
                    ...
                    return n = e.clone(), n.limit = n.offset + o, e.offset += o, n;
                case t.TYPES.message:
        ...
        var d = function (e, i, r, n, o, s) {
            l.call(this, e, i, r, n, s), this.className = "Message", this.extensions = [t.ID_MIN, t.ID_MAX], this.clazz = null, this.isGroup = !!o, this._fields = null, this._fieldsById = null, this._fieldsByName = null
        ...
        p.build = function (i) {
            ...
            var r = function (t, i) {
                function r(i, n, o, s, a) {
                    ...
                    if (null === i || "object" != typeof i) {
                        if (s == t.TYPES["enum"])for (var f = a.getChildren(t.Reflect.Enum.Value), u = 0; u < f.length; u++)if (f[u].id === i) {
                            i = f[u].name;
                            break
                        }
                        l = i
                    } else if (e.isByteBuffer(i))l = n ? i.toBase64() : i.toBuffer(); else if (Array.isArray(i)) {
                        var h = i;
                        l = [];
                        for (var d = 0; d < h.length; d++)l.push(r(h[d], n, o, s, a))
                    } else if (i instanceof t.Map) {
                        var p = i.entries();
                        l = {};
                        for (var c = p.next(); !c.done; c = p.next())l[i.keyElem.valueToString(c.value[0])] = r(c.value[1], n, o, i.valueElem.type, i.valueElem.resolvedType)
                    } else if (i instanceof t.Long)l = o ? i.toString() : new t.Long(i); else {
                        l = {};
                        var m = i.$type, g = void 0;
                        for (var u in i)if (i.hasOwnProperty(u)) {
                            var y = i[u];
                            m && (g = m.getChild(u)), l[u] = r(y, n, o, g.type, g.resolvedType)
                        }
                    }
                    return l
                }

                var n = i.getChildren(t.Reflect.Message.Field), o = i.getChildren(t.Reflect.Message.OneOf), s = function (r, a) {
                    t.Builder.Message.call(this);
                    for (var l = 0, f = o.length; f > l; ++l)this[o[l].name] = null;
                    ...
                    if (arguments.length > 0) {
                        var h;
                        if (1 !== arguments.length || null === r || "object" != typeof r || !("function" != typeof r.encode || r instanceof s) || Array.isArray(r) || r instanceof t.Map || e.isByteBuffer(r) || r instanceof ArrayBuffer || t.Long && r instanceof t.Long)for (l = 0, f = arguments.length; f > l; ++l)"undefined" != typeof(h = arguments[l]) && this.$set(n[l].name, h); else this.$set(r)
                    }
                ...
                a.add = function (e, r, n) {
                    ...
                    if (e && "object" == typeof e) {
                        n = r;
                        for (var o in e)e.hasOwnProperty(o) && "undefined" != typeof(r = e[o]) && this.$set(o, r, n);
                        return this
                    }
                    ...
                    return s && s.oneof && (null !== r ? (null !== this[s.oneof.name] && (this[this[s.oneof.name]] = null), this[s.oneof.name] = s.name) : s.oneof.name === e && (this[s.oneof.name] = null)), this
                ...
                for (var l = 0; l < n.length; l++) {
                    ...
                    f instanceof t.Reflect.Message.ExtensionField || i.builder.options.populateAccessors && function (e) {
                        ...
                        null === i.getChild("set" + t) && (a["set" + t] = n), null === i.getChild("set_" + r) && (a["set_" + r] = n), null === i.getChild("get" + t) && (a["get" + t] = o), null === i.getChild("get_" + r) && (a["get_" + r] = o)
                    }(f)
                }
                return a.encode = function (t, r) {
                    ...
                    try {
                        return i.encode(this, t.LE(), r), (n ? t.flip() : t).LE(o)
                    } catch (s) {
                        throw t.LE(o), s
                    }
                    ...
                    t || (t = new e, r = !0);
                    var n = (new e).LE();
                    return i.encode(this, n).flip(), t.writeVarint32(n.remaining()), t.append(n), r ? t.flip() : t
                }, a.encodeAB = function () {
                    try {
                ...
                }, a.toHex = a.encodeHex, a.toRaw = function (e, i) {
                    ...
                    "string" == typeof t && (t = e.wrap(t, r ? r : "base64")), t = e.isByteBuffer(t) ? t : e.wrap(t);
                    ...
                    if ("string" == typeof t && (t = e.wrap(t, r ? r : "base64")), t = e.isByteBuffer(t) ? t : e.wrap(t), t.remaining() < 1)return null;
                    var n = t.offset, o = t.readVarint32();
                    if (t.remaining() < o)return t.offset = n, null;
                    try {
                    ...
                    return i.toString()
                }, Object.defineProperty && (Object.defineProperty(s, "$options", {value: i.buildOpt()}), Object.defineProperty(a, "$options", {value: s.$options}), Object.defineProperty(s, "$type", {value: i}), Object.defineProperty(a, "$type", {value: i})), s
            }(t, this);
            this._fields = [], this._fieldsById = {}, this._fieldsByName = {};
            for (var n, o = 0, s = this.children.length; s > o; o++)if (n = this.children[o], n instanceof _ || n instanceof d || n instanceof E) {
                ...
                r[n.name] = n.build()
            } else if (n instanceof d.Field)n.build(), this._fields.push(n), this._fieldsById[n.id] = n, this._fieldsByName[n.name] = n; else if (!(n instanceof d.OneOf || n instanceof w))throw Error("Illegal reflect child of " + this.toString(!0) + ": " + this.children[o].toString(!0));
            return this.clazz = r
        }, p.encode = function (e, t, i) {
            for (var r, n, o = null, s = 0, a = this._fields.length; a > s; ++s)r = this._fields[s], n = e[r.name], r.required && null === n ? null === o && (o = r) : r.encode(i ? n : r.verifyValue(n), t);
            if (null !== o) {
            ...
            for (var o, s, a, l, f = e.offset, u = new this.clazz; e.offset < f + i || -1 === i && e.remaining() > 0;) {
                ...
                if (l = this._fieldsById[a])if (l.repeated && !l.options.packed)u[l.name].push(l.decode(s, e)); else if (l.map) {
                    var h = l.decode(s, e);
                    u[l.name].set(h[0], h[1])
                } else u[l.name] = l.decode(s, e), l.oneof && (null !== this[l.oneof.name] && (this[this[l.oneof.name]] = null), u[l.oneof.name] = l.name); else switch (s) {
                    case t.WIRE_TYPES.VARINT:
                        e.readVarint32();
                        break;
                    case t.WIRE_TYPES.BITS32:
            ...
            for (var p = 0, c = this._fields.length; c > p; ++p)if (l = this._fields[p], null === u[l.name]) {
                if (l.required) {
        ...
        var c = function (e, i, r, n, o, a, l, f, u, h) {
            s.call(this, e, i, a), this.className = "Message.Field", this.required = "required" === r, this.repeated = "repeated" === r, this.map = "map" === r, this.keyType = n || null, this.type = o, this.resolvedType = null, this.id = l, this.options = f || {}, this.defaultValue = null, this.oneof = u || null, this.syntax = h || "proto2", this.originalName = this.name, this.element = null, this.keyElement = null, !this.builder.options.convertFieldsToCamelCase || this instanceof d.ExtensionField || (this.name = t.Util.toCamelCase(this.name))
        }, m = c.prototype = Object.create(s.prototype);
        m.build = function () {
            this.element = new u(this.type, this.resolvedType, !1, this.syntax), this.map && (this.keyElement = new u(this.keyType, void 0, !0, this.syntax)), this.defaultValue = "undefined" != typeof this.options["default"] ? this.verifyValue(this.options["default"]) : null, "proto3" !== this.syntax || this.repeated || this.map || (this.defaultValue = this.element.defaultFieldValue(this.type))
            ...
            if (this.repeated && !i) {
                Array.isArray(e) || (e = [e]);
                var o = [];
                for (n = 0; n < e.length; n++)o.push(this.element.verifyValue(e[n]));
                return o
            }
            ...
            try {
                if (this.repeated) {
                    ...
                    if (this.options.packed && t.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType) >= 0) {
                        ...
                        var o = r.offset;
                        for (n = 0; n < i.length; n++)this.element.encodeValue(this.id, i[n], r);
                        var s = r.offset - o, a = e.calculateVarint32(s);
                        if (a > 1) {
                            var l = r.slice(o, r.offset);
                            o += a - 1, r.offset = o, r.append(l)
                        }
                        r.writeVarint32(s, o - a)
                    } else for (n = 0; n < i.length; n++)r.writeVarint32(this.id << 3 | this.type.wireType), this.element.encodeValue(this.id, i[n], r)
                    ...
                    r.writeVarint32(this.id << 3 | t.WIRE_TYPES.LDELIM), r.writeVarint32(s), r.writeVarint32(8 | this.keyType.wireType), this.keyElement.encodeValue(1, n, r), r.writeVarint32(16 | this.type.wireType), this.element.encodeValue(2, i, r)
                }, this) : this.hasWirePresence(i) && (r.writeVarint32(this.id << 3 | this.type.wireType), this.element.encodeValue(this.id, i, r))
            } catch (f) {
            ...
            try {
                if (this.repeated) {
                    var n, o;
                    if (this.options.packed && t.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType) >= 0) {
                        for (r += e.calculateVarint32(this.id << 3 | t.WIRE_TYPES.LDELIM), o = 0, n = 0; n < i.length; n++)o += this.element.calculateLength(this.id, i[n]);
                        r += e.calculateVarint32(o), r += o
                    } else for (n = 0; n < i.length; n++)r += e.calculateVarint32(this.id << 3 | this.type.wireType), r += this.element.calculateLength(this.id, i[n])
                } else this.map ? i.forEach(function (i, n, o) {
                    var s = e.calculateVarint32(8 | this.keyType.wireType) + this.keyElement.calculateLength(1, n) + e.calculateVarint32(16 | this.type.wireType) + this.element.calculateLength(2, i);
                    r += e.calculateVarint32(this.id << 3 | t.WIRE_TYPES.LDELIM), r += e.calculateVarint32(s), r += s
                }, this) : this.hasWirePresence(i) && (r += e.calculateVarint32(this.id << 3 | this.type.wireType), r += this.element.calculateLength(this.id, i))
            } catch (s) {
            ...
            if (!s)throw Error("Illegal wire type for field " + this.toString(!0) + ": " + e + " (" + this.type.wireType + " expected)");
            ...
            if (this.map) {
                ...
                if (n = this.element.defaultFieldValue(this.type), o = i.readVarint32(), i.remaining() < o)throw Error("Illegal number of bytes for " + this.toString(!0) + ": " + o + " required but got only " + i.remaining());
                var f = i.clone();
                for (f.limit = f.offset + o, i.offset += o; f.remaining() > 0;) {
        ...
        var g = function (e, t, i, r, n, o, s) {
            c.call(this, e, t, i, null, r, n, o, s), this.extension
        };
        g.prototype = Object.create(c.prototype), o.Message.ExtensionField = g;
        ...
        }, v = _.prototype = Object.create(l.prototype);
        v.build = function () {
            for (var e = {}, t = this.getChildren(_.Value), i = 0, r = t.length; r > i; ++i)e[t[i].name] = t[i].id;
            return Object.defineProperty && Object.defineProperty(e, "$options", {value: this.buildOpt()}), this.object = e
        }, o.Enum = _;
        var b = function (e, t, i, r) {
            s.call(this, e, t, i), this.className = "Enum.Value", this.id = r
        };
        b.prototype = Object.create(s.prototype), o.Enum.Value = b;
        var w = function (e, t, i, r) {
            s.call(this, e, t, i), this.field = r
        };
        w.prototype = Object.create(s.prototype), o.Extension = w;
                ...
                for (var r = function (e) {
                    ...
                    n[t.name] = function (r, n) {
                        try {
                            ...
                            if (!(r && r instanceof t.resolvedRequestType.clazz))return void setTimeout(n.bind(this, Error("Illegal request type provided to service method " + i.name + "#" + t.name)), 0);
                        ...
                        new r(e)[t.name](i, n)
                    }, Object.defineProperty && (Object.defineProperty(r[t.name], "$options", {value: t.buildOpt()}), Object.defineProperty(n[t.name], "$options", {value: r[t.name].$options}))
                }(o[s]);
        ...
        }, I = R.prototype = Object.create(s.prototype);
        I.buildOpt = f.buildOpt, o.Service.Method = R;
        var S = function (e, t, i, r, n, o, s, a) {
            R.call(this, e, t, i, a), this.className = "Service.RPCMethod", this.requestName = r, this.responseName = n, this.requestStream = o, this.responseStream = s, this.resolvedRequestType = null, this.resolvedResponseType = null
        };
        return S.prototype = Object.create(R.prototype), o.Service.RPCMethod = S, o
    }(t), t.Builder = function (e, t, i) {
        function r(e, t) {
        ...
        return o.reset = function () {
            ...
            if ("string" != typeof e || !t.TYPEREF.test(e))throw Error("Illegal package: " + e);
            var r, n, o = e.split(".");
            for (r = 0; r < o.length; r++)if (!t.NAME.test(o[r]))throw Error("Illegal package: " + o[r]);
            for (r = 0; r < o.length; r++)n = this.ptr.getChild(o[r]), null === n && this.ptr.addChild(n = new i.Namespace(this, this.ptr, o[r])), this.ptr = n;
            return this
        }, n.isValidMessage = function (e) {
            if ("string" != typeof e.name || !t.NAME.test(e.name))return !1;
            if ("undefined" != typeof e.values || "undefined" != typeof e.rpc)return !1;
            var i;
            if ("undefined" != typeof e.fields) {
                if (!Array.isArray(e.fields))return !1;
                var r, o = [];
                for (i = 0; i < e.fields.length; i++) {
                    if (!n.isValidMessageField(e.fields[i]))return !1;
                    if (r = parseInt(e.fields[i].id, 10), o.indexOf(r) >= 0)return !1;
                    o.push(r)
                }
                o = null
            }
            if ("undefined" != typeof e.enums) {
                if (!Array.isArray(e.enums))return !1;
                for (i = 0; i < e.enums.length; i++)if (!n.isValidEnum(e.enums[i]))return !1
            }
            if ("undefined" != typeof e.messages) {
                if (!Array.isArray(e.messages))return !1;
                for (i = 0; i < e.messages.length; i++)if (!n.isValidMessage(e.messages[i]) && !n.isValidExtend(e.messages[i]))return !1
            }
            if ("undefined" != typeof e.extensions && (!Array.isArray(e.extensions) || 2 !== e.extensions.length || "number" != typeof e.extensions[0] || "number" != typeof e.extensions[1]))return !1;
            if ("proto3" === e.syntax) {
                for (i = 0; i < e.fields.length; i++) {
                    var s = e.fields[i];
                    if ("required" === s.rule)return !1;
                    if (s["default"])return !1;
                    if (s.options)for (var a = Object.keys(s.options), l = 0; l < a.length; l++)if ("default" === a[l])return !1
                }
            ...
            if ("undefined" != typeof e.options) {
                ...
                for (var i, r = Object.keys(e.options), n = 0; n < r.length; n++)if ("string" != typeof(i = r[n]) || "string" != typeof e.options[i] && "number" != typeof e.options[i] && "boolean" != typeof e.options[i])return !1
            }
            return !0
        }, n.isValidEnum = function (e) {
            if ("string" != typeof e.name || !t.NAME.test(e.name))return !1;
            if ("undefined" == typeof e.values || !Array.isArray(e.values) || 0 == e.values.length)return !1;
            for (var i = 0; i < e.values.length; i++) {
                if ("object" != typeof e.values[i])return !1;
                if ("string" != typeof e.values[i].name || "undefined" == typeof e.values[i].id)return !1;
                if (!t.NAME.test(e.values[i].name) || !t.NEGID.test("" + e.values[i].id))return !1
            }
            ...
            for (r.push(t); r.length > 0;) {
                ...
                for (; t.length > 0;) {
                    ...
                    if (n.isValidMessage(o)) {
                        var s = new i.Message(this, this.ptr, o.name, o.options, o.isGroup, o.syntax), a = {};
                        if (o.oneofs)for (var l = Object.keys(o.oneofs), f = 0, u = l.length; u > f; ++f)s.addChild(a[l[f]] = new i.Message.OneOf(this, s, l[f]));
                        if (o.fields && o.fields.length > 0)for (f = 0, u = o.fields.length; u > f; ++f) {
                            var h = o.fields[f];
                            if (null !== s.getChild(h.id))throw Error("Duplicate field id in message " + s.name + ": " + h.id);
                            if (h.options)for (var d = Object.keys(h.options), p = 0, c = d.length; c > p; ++p) {
                                if ("string" != typeof d[p])throw Error("Illegal field option name in message " + s.name + "#" + h.name + ": " + d[p]);
                                if ("string" != typeof h.options[d[p]] && "number" != typeof h.options[d[p]] && "boolean" != typeof h.options[d[p]])throw Error("Illegal field option value in message " + s.name + "#" + h.name + "#" + d[p] + ": " + h.options[d[p]])
                            }
                            var m = null;
                            if ("string" == typeof h.oneof && (m = a[h.oneof], "undefined" == typeof m))throw Error("Illegal oneof in message " + s.name + "#" + h.name + ": " + h.oneof);
                            h = new i.Message.Field(this, s, h.rule, h.keytype, h.type, h.name, h.id, h.options, m, o.syntax), m && m.fields.push(h), s.addChild(h)
                        }
                        var g = [];
                        if ("undefined" != typeof o.enums && o.enums.length > 0)for (f = 0; f < o.enums.length; f++)g.push(o.enums[f]);
                        if (o.messages && o.messages.length > 0)for (f = 0; f < o.messages.length; f++)g.push(o.messages[f]);
                        if (o.services && o.services.length > 0)for (f = 0; f < o.services.length; f++)g.push(o.services[f]);
                        if (o.extensions && (s.extensions = o.extensions, s.extensions[0] < e.ID_MIN && (s.extensions[0] = e.ID_MIN), s.extensions[1] > e.ID_MAX && (s.extensions[1] = e.ID_MAX)), this.ptr.addChild(s), g.length > 0) {
                            r.push(t), t = g, g = null, this.ptr = s, s = null;
                            continue
                        }
                        g = null, s = null
                    } else if (n.isValidEnum(o)) {
                        for (s = new i.Enum(this, this.ptr, o.name, o.options, o.syntax), f = 0; f < o.values.length; f++)s.addChild(new i.Enum.Value(this, s, o.values[f].name, o.values[f].id));
                        this.ptr.addChild(s), s = null
                    } else if (n.isValidService(o)) {
                        s = new i.Service(this, this.ptr, o.name, o.options);
                        for (f in o.rpc)o.rpc.hasOwnProperty(f) && s.addChild(new i.Service.RPCMethod(this, s, f, o.rpc[f].request, o.rpc[f].response, !!o.rpc[f].request_stream, !!o.rpc[f].response_stream, o.rpc[f].options));
                        this.ptr.addChild(s), s = null
                    } else {
                        if (!n.isValidExtend(o))throw Error("Not a valid definition: " + JSON.stringify(o));
                        if (s = this.ptr.resolve(o.ref, !0))for (f = 0; f < o.fields.length; f++) {
                            if (null !== s.getChild(o.fields[f].id))throw Error("Duplicate extended field id in message " + s.name + ": " + o.fields[f].id);
                            if (o.fields[f].id < s.extensions[0] || o.fields[f].id > s.extensions[1])throw Error("Illegal extended field id in message " + s.name + ": " + o.fields[f].id + " (" + s.extensions.join(" to ") + " expected)");
                            var y = o.fields[f].name;
                            this.options.convertFieldsToCamelCase && (y = e.Util.toCamelCase(o.fields[f].name)), h = new i.Message.ExtensionField(this, s, o.fields[f].rule, o.fields[f].type, this.ptr.fqn() + "." + y, o.fields[f].id, o.fields[f].options);
                            var _ = new i.Extension(this, this.ptr, o.fields[f].name, h);
                            h.extension = _, this.ptr.addChild(_), s.addChild(h)
            ...
            if ("string" == typeof i) {
                if (e.Util.IS_NODE && (i = require("path").resolve(i)), this.files[i] === !0)return this.reset(), this;
                this.files[i] = !0
            } else if ("object" == typeof i) {
                var n = i.root;
                e.Util.IS_NODE && (n = require("path").resolve(n));
                var o = [n, i.file].join("/");
                if (this.files[o] === !0)return this.reset(), this;
                this.files[o] = !0
            }
            if (t.imports && t.imports.length > 0) {
                var s, a = "/", l = !1;
                "object" == typeof i ? (this.importRoot = i.root, l = !0, s = this.importRoot, i = i.file, (s.indexOf("\\") >= 0 || i.indexOf("\\") >= 0) && (a = "\\")) : "string" == typeof i ? this.importRoot ? s = this.importRoot : i.indexOf("/") >= 0 ? (s = i.replace(/\/[^\/]*$/, ""), "" === s && (s = "/")) : i.indexOf("\\") >= 0 ? (s = i.replace(/\\[^\\]*$/, ""), a = "\\") : s = "." : s = null;
                for (var f = 0; f < t.imports.length; f++)if ("string" == typeof t.imports[f]) {
                    ...
                    if (u = s + a + u, this.files[u] === !0)continue;
            ...
            t["package"] && this.define(t["package"]), t.syntax && r(t.syntax, t);
            var d = this.ptr;
            return t.options && Object.keys(t.options).forEach(function (e) {
                d.options[e] = t.options[e]
            }), t.messages && (this.create(t.messages), this.ptr = d), t.enums && (this.create(t.enums), this.ptr = d), t.services && (this.create(t.services), this.ptr = d), t["extends"] && this.create(t["extends"]), this.reset(), this
        }, n.isValidService = function (e) {
            return !("string" != typeof e.name || !t.NAME.test(e.name) || "object" != typeof e.rpc)
        }, n.isValidExtend = function (e) {
            if ("string" != typeof e.ref || !t.TYPEREF.test(e.ref))return !1;
            var i;
            if ("undefined" != typeof e.fields) {
                if (!Array.isArray(e.fields))return !1;
                var r, o = [];
                for (i = 0; i < e.fields.length; i++) {
                    if (!n.isValidMessageField(e.fields[i]))return !1;
                    if (r = parseInt(e.id, 10), o.indexOf(r) >= 0)return !1;
                    o.push(r)
                }
                o = null
            }
            ...
            if (null != this.ptr && "object" != typeof this.ptr.type) {
                if (this.ptr instanceof i.Namespace)for (var n = this.ptr.children, o = 0, s = n.length; s > o; ++o)this.ptr = n[o], this.resolveAll(); else if (this.ptr instanceof i.Message.Field) {
                    if (t.TYPE.test(this.ptr.type))this.ptr.type = e.TYPES[this.ptr.type]; else {
                        ...
                        if (this.ptr.resolvedType = r, r instanceof i.Enum) {
                            if (this.ptr.type = e.TYPES["enum"], "proto3" === this.ptr.syntax && "proto3" !== r.syntax)throw Error("Proto3 message refers to proto2 enum; this is not allowed due to differing enum semantics in proto3")
                        } else {
                    ...
                    if (this.ptr.map) {
                        if (!t.TYPE.test(this.ptr.keyType))throw Error("Illegal key type for map field in " + this.ptr.toString(!0) + ": " + this.ptr.type);
                        this.ptr.keyType = e.TYPES[this.ptr.keyType]
                    }
                } else if (this.ptr instanceof e.Reflect.Enum.Value); else if (this.ptr instanceof e.Reflect.Service.Method) {
    ...
    }(t, t.Lang, t.Reflect), t.Map = function (e, t) {
        function i(e) {
            var t = 0;
            return {
                next: function () {
        ...
        var r = function (e, i) {
            ...
            if (this.field = e, this.keyElem = new t.Element(e.keyType, null, !0, e.syntax), this.valueElem = new t.Element(e.type, e.resolvedType, !1, e.syntax), this.map = {}, Object.defineProperty(this, "size", {
                ...
                var o = this.keyElem.valueFromString(r[n]), s = this.valueElem.verifyValue(i[r[n]]);
    ...
    }(t, t.Reflect), t.loadProto = function (e, i, r) {
        return ("string" == typeof i || i && "string" == typeof i.file && "string" == typeof i.root) && (r = i, i = void 0), t.loadJson(new t.DotProto.Parser(e).parse(), i, r)
    }, t.protoFromString = t.loadProto, t.loadProtoFile = function (e, i, r) {
        if (i && "object" == typeof i ? (r = i, i = null) : i && "function" == typeof i || (i = null), i)return t.Util.fetch("string" == typeof e ? e : e.root + "/" + e.file, function (n) {
            if (null === n)return void i(Error("Failed to fetch file"));
            try {
        ...
        return e = e || {}, "undefined" == typeof e.convertFieldsToCamelCase && (e.convertFieldsToCamelCase = t.convertFieldsToCamelCase), "undefined" == typeof e.populateAccessors && (e.populateAccessors = t.populateAccessors), new t.Builder(e)
    }, t.loadJson = function (e, i, r) {
        return ("string" == typeof i || i && "string" == typeof i.file && "string" == typeof i.root) && (r = i, i = null), i && "object" == typeof i || (i = t.newBuilder()), "string" == typeof e && (e = JSON.parse(e)), i["import"](e, r), i.resolveAll(), i
    ...
    var o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", s = function (e) {
        for (var t = {}, i = 0, r = e.length; r > i; i++)t[e.charAt(i)] = i;
        return t
    }(o), a = String.fromCharCode, l = function (e) {
        if (e.length < 2) {
    ...
    }, f = /[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g, u = function (e) {
        return e.replace(f, l)
    }, h = function (e) {
        var t = [0, 2, 1][e.length % 3], i = e.charCodeAt(0) << 16 | (e.length > 1 ? e.charCodeAt(1) : 0) << 8 | (e.length > 2 ? e.charCodeAt(2) : 0), r = [o.charAt(i >>> 18), o.charAt(i >>> 12 & 63), t >= 2 ? "=" : o.charAt(i >>> 6 & 63), t >= 1 ? "=" : o.charAt(63 & i)];
        return r.join("")
    }, d = e.btoa ? function (t) {
        return e.btoa(t)
    } : function (e) {
        ...
        return c(e, !0)
    }, g = new RegExp(["[À-ß][-¿]", "[à-ï][-¿]{2}", "[ð-÷][-¿]{3}"].join("|"), "g"), y = function (e) {
        switch (e.length) {
            case 4:
        ...
        var t = e.length, i = t % 4, r = (t > 0 ? s[e.charAt(0)] << 18 : 0) | (t > 1 ? s[e.charAt(1)] << 12 : 0) | (t > 2 ? s[e.charAt(2)] << 6 : 0) | (t > 3 ? s[e.charAt(3)] : 0), n = [a(r >>> 16), a(r >>> 8 & 255), a(255 & r)];
...
var RC4 = function () {
    return {
        decode: function (e, t) {
            ...
            for (e instanceof ArrayBuffer && (e = new Uint8Array(e)), o = e instanceof Uint8Array, s = o ? e.byteLength : e.length, i = 0; 256 > i; i++)a[i] = i;
            for (i = 0; 256 > i; i++)l = (l + a[i] + t.charCodeAt(i % t.length)) % 256, r = a[i], a[i] = a[l], a[l] = r;
            for (i = 0, l = 0, n = 0; s > n; n++)i = (i + 1) % 256, l = (l + a[i]) % 256, r = a[i], a[i] = a[l], a[l] = r, f[n] = (o ? e[n] : e.charCodeAt(n)) ^ a[(a[i] + a[l]) % 256], o || (f[n] = String.fromCharCode(f[n]));
...
!function (e) {
    ...
    function l(e, i) {
        ...
        var r, l, f, u, h, d = 1732584193, p = -271733879, c = -1732584194, m = 271733878;
        for (r = 0; r < e.length; r += 16)l = d, f = p, u = c, h = m, d = n(d, p, c, m, e[r], 7, -680876936), m = n(m, d, p, c, e[r + 1], 12, -389564586), c = n(c, m, d, p, e[r + 2], 17, 606105819), p = n(p, c, m, d, e[r + 3], 22, -1044525330), d = n(d, p, c, m, e[r + 4], 7, -176418897), m = n(m, d, p, c, e[r + 5], 12, 1200080426), c = n(c, m, d, p, e[r + 6], 17, -1473231341), p = n(p, c, m, d, e[r + 7], 22, -45705983), d = n(d, p, c, m, e[r + 8], 7, 1770035416), m = n(m, d, p, c, e[r + 9], 12, -1958414417), c = n(c, m, d, p, e[r + 10], 17, -42063), p = n(p, c, m, d, e[r + 11], 22, -1990404162), d = n(d, p, c, m, e[r + 12], 7, 1804603682), m = n(m, d, p, c, e[r + 13], 12, -40341101), c = n(c, m, d, p, e[r + 14], 17, -1502002290), p = n(p, c, m, d, e[r + 15], 22, 1236535329), d = o(d, p, c, m, e[r + 1], 5, -165796510), m = o(m, d, p, c, e[r + 6], 9, -1069501632), c = o(c, m, d, p, e[r + 11], 14, 643717713), p = o(p, c, m, d, e[r], 20, -373897302), d = o(d, p, c, m, e[r + 5], 5, -701558691), m = o(m, d, p, c, e[r + 10], 9, 38016083), c = o(c, m, d, p, e[r + 15], 14, -660478335), p = o(p, c, m, d, e[r + 4], 20, -405537848), d = o(d, p, c, m, e[r + 9], 5, 568446438), m = o(m, d, p, c, e[r + 14], 9, -1019803690), c = o(c, m, d, p, e[r + 3], 14, -187363961), p = o(p, c, m, d, e[r + 8], 20, 1163531501), d = o(d, p, c, m, e[r + 13], 5, -1444681467), m = o(m, d, p, c, e[r + 2], 9, -51403784), c = o(c, m, d, p, e[r + 7], 14, 1735328473), p = o(p, c, m, d, e[r + 12], 20, -1926607734), d = s(d, p, c, m, e[r + 5], 4, -378558), m = s(m, d, p, c, e[r + 8], 11, -2022574463), c = s(c, m, d, p, e[r + 11], 16, 1839030562), p = s(p, c, m, d, e[r + 14], 23, -35309556), d = s(d, p, c, m, e[r + 1], 4, -1530992060), m = s(m, d, p, c, e[r + 4], 11, 1272893353), c = s(c, m, d, p, e[r + 7], 16, -155497632), p = s(p, c, m, d, e[r + 10], 23, -1094730640), d = s(d, p, c, m, e[r + 13], 4, 681279174), m = s(m, d, p, c, e[r], 11, -358537222), c = s(c, m, d, p, e[r + 3], 16, -722521979), p = s(p, c, m, d, e[r + 6], 23, 76029189), d = s(d, p, c, m, e[r + 9], 4, -640364487), m = s(m, d, p, c, e[r + 12], 11, -421815835), c = s(c, m, d, p, e[r + 15], 16, 530742520), p = s(p, c, m, d, e[r + 2], 23, -995338651), d = a(d, p, c, m, e[r], 6, -198630844), m = a(m, d, p, c, e[r + 7], 10, 1126891415), c = a(c, m, d, p, e[r + 14], 15, -1416354905), p = a(p, c, m, d, e[r + 5], 21, -57434055), d = a(d, p, c, m, e[r + 12], 6, 1700485571), m = a(m, d, p, c, e[r + 3], 10, -1894986606), c = a(c, m, d, p, e[r + 10], 15, -1051523), p = a(p, c, m, d, e[r + 1], 21, -2054922799), d = a(d, p, c, m, e[r + 8], 6, 1873313359), m = a(m, d, p, c, e[r + 15], 10, -30611744), c = a(c, m, d, p, e[r + 6], 15, -1560198380), p = a(p, c, m, d, e[r + 13], 21, 1309151649), d = a(d, p, c, m, e[r + 4], 6, -145523070), m = a(m, d, p, c, e[r + 11], 10, -1120210379), c = a(c, m, d, p, e[r + 2], 15, 718787259), p = a(p, c, m, d, e[r + 9], 21, -343485551), d = t(d, l), p = t(p, f), c = t(c, u), m = t(m, h);
        return [d, p, c, m]
    }
    ...
    function d(e, t) {
        var i, r, n = u(e), o = [], s = [];
        for (o[15] = s[15] = void 0, n.length > 16 && (n = l(n, 8 * e.length)), i = 0; 16 > i; i += 1)o[i] = 909522486 ^ n[i], s[i] = 1549556828 ^ n[i];
        return r = l(o.concat(u(t)), 512 + 8 * t.length), f(l(s.concat(r), 640))
    }

    function p(e) {
        var t, i, r = "0123456789abcdef", n = "";
        for (i = 0; i < e.length; i += 1)t = e.charCodeAt(i), n += r.charAt(t >>> 4 & 15) + r.charAt(15 & t);
        return n
    }
    ...
    function v(e, t, i) {
        return t ? i ? y(t, e) : _(t, e) : i ? m(e) : g(e)
    }
    ...
    var r = e.prototype, n = this, o = n.EventEmitter;
    r.getListeners = function (e) {
        var t, i, r = this._getEvents();
        if (e instanceof RegExp) {
            t = {};
            for (i in r)r.hasOwnProperty(i) && e.test(i) && (t[i] = r[i])
        } else t = r[e] || (r[e] = []);
        return t
        ...
        for (r in n)n.hasOwnProperty(r) && -1 === t(n[r], i) && n[r].push(o ? i : {listener: i, once: !1});
        return this
        ...
        for (n in o)o.hasOwnProperty(n) && (r = t(o[n], i), -1 !== r && o[n].splice(r, 1));
        return this
        ...
        if ("object" != typeof t || t instanceof RegExp)for (r = i.length; r--;)o.call(this, t, i[r]); else for (r in t)t.hasOwnProperty(r) && (n = t[r]) && ("function" == typeof n ? o.call(this, r, n) : s.call(this, r, n));
        return this
    }, r.removeEvent = function (e) {
        var t, i = typeof e, r = this._getEvents();
        if ("string" === i)delete r[e]; else if (e instanceof RegExp)for (t in r)r.hasOwnProperty(t) && e.test(t) && delete r[t]; else delete this._events;
        return this
    }, r.removeAllListeners = i("removeEvent"), r.emitEvent = function (e, t) {
        var i, r, n, o, s = this.getListenersAsObject(e);
        for (n in s)if (s.hasOwnProperty(n))for (r = s[n].length; r--;)i = s[n][r], i.once === !0 && this.removeListener(e, i.listener), o = i.listener.apply(this, t || []), o === this._getOnceReturnValue() && this.removeListener(e, i.listener);
        return this
...
var _addressBookProtoBuilder = dcodeIO.ProtoBuf.newBuilder({})["import"]({
    ...
    options: {java_package: "com.qihoo.contact.cloud.protocol.messages", java_outer_classname: "CommunicationData"},
    messages: [{
        name: "Pair",
        fields: [{rule: "required", type: "bytes", name: "key", id: 1}, {
            rule: "optional",
            type: "bytes",
            name: "value",
            id: 2
        ...
        name: "Error",
        fields: [{rule: "required", type: "uint32", name: "id", id: 1}, {
            rule: "optional",
            type: "bytes",
            name: "description",
            id: 2
        ...
        name: "User",
        fields: [{rule: "required", type: "string", name: "userid", id: 1}, {
            rule: "repeated",
            type: "Pair",
            name: "property_pairs",
            id: 2
        ...
        name: "Info",
        fields: [{rule: "repeated", type: "Pair", name: "property_pairs", id: 1}]
    }, {
        name: "RestoreSessionReq",
        fields: [{rule: "required", type: "string", name: "session_id", id: 1}, {
            rule: "required",
            type: "uint32",
            name: "net_type",
            id: 2
        ...
        fields: [{rule: "required", type: "uint32", name: "timestamp", id: 1}, {
            rule: "optional",
            type: "string",
            name: "client_login_ip",
            id: 2
        }, {rule: "optional", type: "string", name: "server_ip", id: 3}]
    }, {
        name: "LoginReq",
        fields: [{rule: "required", type: "string", name: "mobile_type", id: 1}, {
            rule: "required",
            type: "uint32",
            name: "net_type",
            id: 2
        }, {rule: "required", type: "string", name: "server_ram", id: 3}, {
            rule: "optional",
            type: "bytes",
            name: "secret_ram",
            id: 4
        }, {rule: "optional", type: "uint32", name: "app_id", id: 5, options: {"default": 2e3}}, {
            rule: "optional",
            type: "uint32",
            name: "heart_feq",
            id: 6,
            options: {"default": 300}
        }, {rule: "optional", type: "string", name: "deviceid", id: 7, options: {"default": ""}}, {
            rule: "optional",
            type: "string",
            name: "platform",
            id: 8
        }, {rule: "optional", type: "string", name: "verf_code", id: 9}]
    }, {
        name: "LoginResp",
        fields: [{rule: "required", type: "uint32", name: "timestamp", id: 1}, {
            rule: "required",
            ...
            name: "session_id",
            id: 2
        }, {rule: "required", type: "string", name: "session_key", id: 3}, {
            rule: "optional",
            type: "string",
            name: "client_login_ip",
            id: 4
        }, {rule: "optional", type: "string", name: "serverip", id: 5}]
    }, {
        name: "ChatReq",
        fields: [{rule: "required", type: "bytes", name: "body", id: 1}, {
            rule: "optional",
            type: "uint32",
            name: "body_id",
            id: 2
        }, {rule: "optional", type: "uint32", name: "more_flag", id: 3}, {
            rule: "required",
            type: "uint32",
            name: "body_type",
            id: 4
        }, {rule: "optional", type: "bool", name: "store", id: 5}, {
            rule: "optional",
            type: "bytes",
            name: "m_parameter",
            id: 6
        }, {rule: "optional", type: "uint32", name: "service_id", id: 7}, {
            rule: "optional",
            type: "bytes",
            name: "s_parameter",
            id: 8
        }, {rule: "optional", type: "string", name: "conv_id", id: 9}, {
            rule: "optional",
            type: "bool",
            name: "is_new_conv",
            id: 10,
        ...
        name: "ChatResp",
        fields: [{rule: "required", type: "uint32", name: "result", id: 1}, {
            rule: "optional",
            type: "uint32",
            name: "body_id",
            id: 2
        ...
        name: "QueryInfoReq",
        fields: [{rule: "required", type: "int64", name: "last_info_id", id: 1}, {
            rule: "optional",
            type: "string",
            name: "info_type",
            id: 2
        ...
        name: "GetInfoReq",
        fields: [{rule: "required", type: "string", name: "info_type", id: 1}, {
            rule: "required",
            type: "int64",
            name: "get_info_id",
            id: 2
        }, {rule: "optional", type: "int32", name: "get_info_offset", id: 3}, {
            rule: "optional",
            type: "bytes",
            name: "s_parameter",
            id: 4
        ...
        fields: [{rule: "required", type: "string", name: "info_type", id: 1}, {
            ...
            name: "infos",
            id: 2
        }, {rule: "optional", type: "int64", name: "last_info_id", id: 3}, {
            rule: "optional",
            type: "bytes",
            name: "s_parameter",
            id: 4
        }]
    }, {name: "LogoutReq", fields: [{rule: "optional", type: "string", name: "reason", id: 1}]}, {
        name: "LogoutResp",
        fields: [{rule: "required", type: "uint32", name: "result", id: 1}]
    }, {
        ...
        fields: [{rule: "required", type: "bool", name: "online", id: 1}]
    }, {
        name: "QueryUserRegReq",
        fields: [{rule: "required", type: "string", name: "userid", id: 1}]
    }, {
        name: "QueryUserRegResp",
        fields: [{rule: "required", type: "bool", name: "result", id: 1}]
    }, {
        name: "InitLoginReq",
        fields: [{rule: "required", type: "string", name: "client_ram", id: 1}]
    }, {
        name: "InitLoginResp",
        fields: [{rule: "required", type: "string", name: "client_ram", id: 1}, {
            rule: "required",
    ...
    }, {name: "ExQueryUserStatusReq", fields: [{rule: "required", type: "string", name: "userid", id: 1}]}, {
        name: "ExQueryUserStatusResp", fields: [{
            rule: "required", type: "int32", name: "status",
            id: 1
        }, {rule: "optional", type: "uint32", name: "app_id", id: 2}, {
            rule: "optional",
            type: "string",
            name: "mobile_type",
            id: 3
        }, {rule: "optional", type: "uint32", name: "client_ver", id: 4}]
    }, {
        name: "Service_Req",
        fields: [{rule: "required", type: "uint32", name: "service_id", id: 1}, {
            rule: "required",
            type: "bytes",
            name: "request",
            id: 2
        ...
        fields: [{rule: "required", type: "string", name: "userid", id: 1}, {
            ...
            name: "user_type",
            id: 2
        }, {rule: "optional", type: "uint32", name: "app_id", id: 3}]
    }, {
        name: "RespEQ1User",
        fields: [{rule: "required", type: "string", name: "userid", id: 1}, {
            rule: "required",
            ...
            name: "user_type",
            id: 2
        }, {rule: "required", type: "int32", name: "status", id: 3}, {
            rule: "optional",
            type: "string",
            name: "jid",
            id: 4
        }, {rule: "optional", type: "uint32", name: "app_id", id: 5}, {
            rule: "optional",
            type: "string",
            name: "platform",
            id: 6
        }, {rule: "optional", type: "string", name: "mobile_type", id: 7}, {
            rule: "optional",
            type: "uint32",
            name: "client_ver",
            id: 8
        ...
        fields: [{rule: "repeated", type: "ReqEQ1User", name: "user_list", id: 1}]
    }, {
        name: "Ex1QueryUserStatusResp",
        fields: [{rule: "repeated", type: "RespEQ1User", name: "user_list", id: 1}]
    }, {
        ...
        fields: [{rule: "required", type: "string", name: "conv_id", id: 1}]
    }, {
        ...
        name: "Request",
        fields: [{rule: "optional", type: "RestoreSessionReq", name: "restore", id: 1}, {
            rule: "optional",
            type: "LoginReq",
            name: "login",
            id: 2
        }, {rule: "optional", type: "ChatReq", name: "chat", id: 3}, {
            rule: "optional",
            type: "QueryInfoReq",
            name: "query_info",
            id: 4
        }, {rule: "optional", type: "GetInfoReq", name: "get_info", id: 5}, {
            rule: "optional",
            type: "LogoutReq",
            name: "logout",
            id: 6
        }, {rule: "optional", type: "QueryUserStatusReq", name: "query_user", id: 7}, {
            rule: "optional",
            type: "QueryUserRegReq",
            name: "query_reg",
            id: 8
        }, {rule: "optional", type: "InitLoginReq", name: "init_login_req", id: 9}, {
            rule: "optional",
            type: "ExQueryUserStatusReq",
            name: "e_query_user",
            id: 10
        }, {rule: "optional", type: "Service_Req", name: "service_req", id: 11}, {
            rule: "optional",
            type: "Ex1QueryUserStatusReq",
            name: "e1_query_user",
            id: 12
        }, {rule: "optional", type: "QueryPeerMsgMaxIdReq", name: "query_peer_max_id", id: 13}, {
            rule: "optional",
        ...
        name: "Response",
        fields: [{rule: "optional", type: "Error", name: "error", id: 1}, {
            rule: "optional",
            type: "RestoreSessionResp",
            name: "restore",
            id: 2
        }, {rule: "optional", type: "LoginResp", name: "login", id: 3}, {
            rule: "optional",
            type: "ChatResp",
            name: "chat",
            id: 4
        }, {rule: "optional", type: "QueryInfoResp", name: "query_info", id: 5}, {
            rule: "optional",
            type: "GetInfoResp",
            name: "get_info",
            id: 6
        }, {rule: "optional", type: "LogoutResp", name: "logout", id: 7}, {
            rule: "optional",
            type: "QueryUserStatusResp",
            name: "query_user",
            id: 8
        }, {rule: "optional", type: "QueryUserRegResp", name: "query_reg", id: 9}, {
            rule: "optional",
            type: "InitLoginResp",
            name: "init_login_resp",
            id: 10
        }, {rule: "optional", type: "ExQueryUserStatusResp", name: "e_query_user", id: 11}, {
            rule: "optional",
            type: "Service_Resp",
            name: "service_resp",
            id: 12
        }, {rule: "optional", type: "Ex1QueryUserStatusResp", name: "e1_query_user", id: 13}, {
            rule: "optional",
            type: "QueryPeerMsgMaxIdResp",
            name: "query_peer_max_id",
            id: 14
        }, {rule: "optional", type: "QueryConvSummaryResp", name: "query_conv_summary", id: 15}]
    }, {
        ...
        fields: [{rule: "required", type: "string", name: "info_type", id: 1}, {
            ...
            name: "info_content",
            id: 2
        }, {rule: "optional", type: "int64", name: "info_id", id: 3}, {
            rule: "optional",
            type: "uint32",
        ...
        name: "ReLoginNotify",
        fields: [{rule: "optional", type: "string", name: "new_ip", id: 1}]
    }, {
        name: "ReConnectNotify",
        fields: [{rule: "optional", type: "string", name: "ip", id: 1}, {
            rule: "optional",
            type: "uint32",
            name: "port",
            id: 2
        ...
        name: "Notify",
        fields: [{rule: "optional", type: "NewMessageNotify", name: "newinfo_ntf", id: 1}, {
            rule: "optional",
            type: "ReLoginNotify",
            name: "relogin_ntf",
            id: 2
        }, {rule: "optional", type: "ReConnectNotify", name: "reconnect_ntf", id: 3}]
    }, {name: "Ack", fields: [{rule: "required", type: "uint32", name: "result", id: 1}]}, {
        name: "RouteInfo",
        fields: [{rule: "required", type: "bytes", name: "username", id: 1}, {
            rule: "required",
            type: "string",
            name: "msg_exchanger",
            id: 2
        }, {rule: "required", type: "string", name: "msg_router", id: 3}]
    }, {
        name: "Proxy",
        fields: [{rule: "required", type: "string", name: "sender", id: 1}, {
            rule: "repeated",
            type: "RouteInfo",
            name: "receiver",
            id: 2
        ...
        name: "Message",
        fields: [{rule: "required", type: "uint32", name: "msgid", id: 1}, {
            rule: "required",
            type: "uint64",
            name: "sn",
            id: 2
        }, {rule: "optional", type: "string", name: "sender", id: 3}, {
            rule: "optional",
            type: "string",
            name: "receiver",
            id: 4
        }, {rule: "optional", type: "string", name: "receiver_type", id: 5}, {
            rule: "optional",
            type: "Request",
            name: "req",
            id: 6
        }, {rule: "optional", type: "Response", name: "resp", id: 7}, {
            rule: "optional",
            type: "Notify",
            name: "notify",
            id: 8
        }, {rule: "optional", type: "Ack", name: "ack", id: 9}, {
            rule: "optional",
            type: "Proxy",
            name: "proxy_mesg",
            id: 10
        }, {rule: "optional", type: "uint64", name: "client_data", id: 11}, {
            rule: "optional",
            type: "string",
            name: "sender_type",
            id: 12
        }, {rule: "optional", type: "string", name: "sender_jid", id: 13}]
    }]
}), _chatroomProtoBuilder = dcodeIO.ProtoBuf.newBuilder({})["import"]({
    "package": "qihoo.protocol.chatroom",
    options: {java_package: "com.qihoo.contact.cloud.protocol.messages", java_outer_classname: "ChatRoom"},
    messages: [{
        name: "CRPair",
        fields: [{rule: "required", type: "string", name: "key", id: 1}, {
            rule: "optional",
            type: "bytes",
            name: "value",
            id: 2
        ...
        name: "CRUser",
        fields: [{rule: "optional", type: "bytes", name: "userid", id: 1}, {
            rule: "optional",
            type: "string",
            name: "name",
            id: 2
        ...
        name: "ChatRoom",
        fields: [{rule: "required", type: "bytes", name: "roomid", id: 1}, {
            rule: "optional",
            type: "CRUser",
            name: "creater",
            id: 2
        ...
        fields: [{rule: "optional", type: "string", name: "gameid", id: 1}, {
            rule: "optional",
            type: "string",
            name: "roomname",
            id: 2
        ...
        fields: [{rule: "optional", type: "ChatRoom", name: "room", id: 1}]
    }, {
        name: "CreateMultiChatRoomRequest",
        fields: [{rule: "repeated", type: "CreateChatRoomRequest", name: "rooms", id: 1}, {
            rule: "optional",
            type: "CRUser",
            name: "creater",
            id: 2
        ...
        fields: [{rule: "repeated", type: "ChatRoom", name: "rooms", id: 1}, {
            rule: "optional",
            type: "CRUser",
            name: "creater",
            id: 2
        ...
        fields: [{rule: "repeated", type: "CRPair", name: "maplist", id: 1}]
    }, {
        name: "QueryChatRoomIDRequest",
        fields: [{rule: "required", type: "string", name: "gameid", id: 1}]
    }, {
        name: "QueryChatRoomIDResponse",
        fields: [{rule: "optional", type: "bytes", name: "roomid", id: 1}, {
            rule: "optional",
            type: "string",
            name: "gameid",
            id: 2
        ...
        fields: [{rule: "required", type: "ChatRoom", name: "room", id: 1}]
    }, {
        ...
        fields: [{rule: "optional", type: "CRUser", name: "sender", id: 1}, {
            rule: "required",
            type: "bytes",
            name: "roomid",
            id: 2
        ...
        fields: [{rule: "optional", type: "uint64", name: "msgid", id: 1}]
    }, {
        name: "ChatRoomNewMsg",
        fields: [{rule: "required", type: "bytes", name: "roomid", id: 1}, {
            rule: "optional",
        ...
        fields: [{rule: "required", type: "int32", name: "type", id: 1}, {
            rule: "required",
            type: "bytes",
            name: "data",
            id: 2
        ...
        fields: [{rule: "required", type: "uint32", name: "payloadtype", id: 1}, {
            rule: "optional",
        ...
        fields: [{rule: "required", type: "int32", name: "result", id: 1}, {
            rule: "required",
            type: "uint32",
            name: "payloadtype",
            id: 2
...
!function (e) {
    ...
    var i = e.dcodeIO.ByteBuffer, r = e.RC4, n = e.Base64, o = e.navigator.userAgent.toLowerCase(), s = ["hasOwnProperty", "valueOf", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "constructor"], a = function () {
    }, l = 0, f = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", u = console && console.log ? function () {
        ...
        extend: function (e, t) {
            if (e && t && "object" == typeof t) {
                var i, r, n;
                for (i in t)e[i] = t[i];
                if (s)for (r = s.length; r--;)n = s[r], t.hasOwnProperty(n) && (e[n] = t[n])
            }
            return e
        }, leftPad: function (e, t, i) {
            var r = String(e);
            for (i = i || " "; r.length < t;)r = i + r;
            return r
        }, randomString: function (e, t) {
            for (var i = [], r = t ? f.slice(0, 10) : f, n = 0; e > n; n++)i.push(r.charAt(Math.floor(Math.random() * r.length)));
            return i.join("")
        }, randomNumber: function (e) {
            return parseInt(h.randomString(e, !0), 10)
        }, defaultKey: function () {
            function e(e) {
                return r.decode(n.decode(e), u)
            }

            var t = "w7h6VMOWbcKqCGA=", i = "wqh+VMKMO8KrCzE=", o = "w7kvUsOXOMO9DGc=", s = "w7IsVcKOPsO+Dmg=", a = "w7IiVcKMO8K+Dzg=", l = "w7I6VMOOOMO9DGc=", f = 1, u = "socket" + (f ? "" : t + i + o + s) + "io", h = e(t), d = e(i), p = e(o), c = e(s), m = e(a), g = e(l);
            return h + d + p + c + (f ? "" : m + g)
        }(), makeVerfCode: function (e) {
            var t = "360tantan@1408$";
            return md5(e + t).substring(24)
        }
    }, d = {
        wp: function () {
            return -1 !== o.indexOf("windows phone ") ? /\bwindows phone (?:os )?([0-9.]+)/ : -1 !== o.indexOf("xblwp") ? /\bxblwp([0-9.]+)/ : -1 !== o.indexOf("zunewp") ? /\bzunewp([0-9.]+)/ : /\bwindows phone/
        }().test(o), ios: function () {
            return /\bcpu(?: iphone)? os /.test(o) ? /\bcpu(?: iphone)? os ([0-9._]+)/ : -1 !== o.indexOf("iph os ") ? /\biph os ([0-9_]+)/ : /\bios\b/
        }().test(o), android: function () {
            return -1 !== o.indexOf("android") ? /\bandroid[ \/-]?([0-9.x]+)?/ : -1 !== o.indexOf("adr") ? -1 !== o.indexOf("mqqbrowser") ? /\badr[ ]\(linux; u; ([0-9.]+)?/ : /\badr(?:[ ]([0-9.]+))?/ : /\bandroid/
        }().test(o)
    }, p = {
    ...
    h.extend(g.prototype, {
        defaultConfig: {
            ...
            var i = this;
            if (this.config = h.extend(h.extend({}, this.defaultConfig), t), !this.config.roomId)throw new Error("WebSocketIO初始化失败：缺少roomId");
            this.config.roomId = String(this.config.roomId), this.config.debug || (u = a), this.config.sender = String(this.config.userId) || String(this.config.sender), this.config.sender || (this.config.sender = h.randomString(11, !0) + Date.now()), this.config.password || (this.config.password = this.config.sender), e._addressBookProtoBuilder && e._chatroomProtoBuilder ? (this._addressBookProto = e._addressBookProtoBuilder, this._chatroomProto = e._chatroomProtoBuilder) : u("WebSocketIO初始化失败：缺少必要的proto文件"), this.ee = new EventEmitter;
            var r = EventEmitter.prototype;
            for (var n in r)r.hasOwnProperty(n) && !/^_/.test(n) && (this[n] = this._createEventHandle(n));
            this.connect(), e.onbeforeunload = function () {
                i.socket.onclose = function () {
                }, i.close()
            }
        }, _createEventHandle: function (e) {
            var t = this.ee;
            return function () {
                t[e].apply(t, arguments)
            }
        }, _createSocketHandle: function (e) {
            var t = this;
            return function () {
                t["_handle" + e.charAt(0).toUpperCase() + e.slice(1)].apply(t, arguments)
            }
        }, _getProtoMessage: function (e, t) {
            this._protoMessageClasses = this._protoMessageClasses || {}, this._protoMessageClasses[e] = this._protoMessageClasses[e] || {};
            var i = this._protoMessageClasses[e][t];
            return i || (i = this["_" + e + "Proto"].build(t), this._protoMessageClasses[e][t] = i), i
        }, _newAddressBookMessage: function (e, t) {
            var i = this._getProtoMessage("addressBook", "qihoo.protocol.messages." + e);
            return new i(t)
        }, _newChatroomMessage: function (e, t) {
            var i = this._getProtoMessage("chatroom", "qihoo.protocol.chatroom." + e);
            return new i(t)
        }, _newChatroomRequestMessage: function (e) {
            var t = this.config, r = new i(t.roomId.length).writeString(t.roomId).flip().toArrayBuffer();
            return this._newChatroomMessage("ChatRoomPacket", {
                client_sn: this._sn,
                roomid: r,
                appid: t.appId,
                uuid: md5(h.randomString(10) + h.leftPad(++l, 10, "0") + Date.now()),
                to_server_data: this._newChatroomMessage("ChatRoomUpToServer", e)
            })
        }, _newAddressBookRequestMessage: function (e, t, i) {
            var r = this.config;
            return this._sn = i || h.randomNumber(10), this._newAddressBookMessage("Message", {
                msgid: e,
                sn: this._sn,
                sender: r.sender,
        ...
        }, _parseAddressBookMessage: function (e) {
            return this._getProtoMessage("addressBook", "qihoo.protocol.messages.Message").decode(e)
        }, _parseChatroomMessage: function (e) {
            return this._getProtoMessage("chatroom", "qihoo.protocol.chatroom.ChatRoomPacket").decode(e)
        }, _handleOpen: function (e) {
            this.connectTryTimes = 0, this.connected = !0, this.handshake || this._sendHandshakePack()
        }, _handleClose: function (e) {
            this._clearStatus(), this.emit("close")
        }, _handleError: function (e) {
            this.connectTryTimes = 0 | this.connectTryTimes, this.connectTryTimes < 3 ? (++this.connectTryTimes, this.reconnect()) : this.emit("error")
        ...
        }, _sendHandshakePack: function () {
            var e = this.config, t = 0, n = new i(12);
            n.writeString(e.flag).writeInt8(e.protocolVersion << 4).writeInt8(e.clientVersion).writeInt16(e.appId).writeInt32(0).writeInt16(0), t += n.view.byteLength, t += 4;
            var o = this._newAddressBookRequestMessage(p.InitLoginReq, {init_login_req: this._newAddressBookMessage("InitLoginReq", {client_ram: h.randomString(10)})}), s = r.encode(new Uint8Array(o.toArrayBuffer()), e.defaultKey);
            t += s.byteLength, n.writeInt32(t).append(s).flip(), this._send(n.toArrayBuffer())
        }, _processHandShakePack: function (e) {
            var n, o = this.config, s = new i(6);
            s.append(e);
            try {
                var a = s.readString(2, i.METRICS_CHARS, 0).string;
                if (a !== o.flag)throw new Error("服务器响应标识（flag）有误");
                s = s.slice(6, s.view.byteLength);
                try {
                    n = this._parseAddressBookMessage(r.decode(s.toArrayBuffer(), o.defaultKey).buffer)
                } catch (l) {
                    throw new Error("解析消息体异常")
                }
                if (n.msgid !== p.InitLoginResp)throw new Error("响应msgid异常，msgid == " + n.msgid);
                if (!this._sn || !n.sn || !n.sn.equals(this._sn))throw new Error("sn验证失败, Message Type: " + t(n.msgid));
                this.handshake = !0, this.emit("handshake"), this._sendLoginPack(n.resp)
            } catch (l) {
                this.close(), u("WebSocketIO握手失败", l), this.emit("handshakefail")
            }
        }, _sendLoginPack: function (e) {
            var t = this.config, n = t.password, o = 4, s = new i(4), a = e.init_login_resp.server_ram;
            try {
                var l = this._newAddressBookRequestMessage(p.LoginReq, {
                    login: this._newAddressBookMessage("LoginReq", {
                        app_id: t.appId,
                        server_ram: a,
                        secret_ram: r.encode(new i(a.length + 8).writeString(a + h.randomString(8)).view, n),
                        verf_code: h.makeVerfCode(t.sender),
                        net_type: 4,
                        mobile_type: d.android ? "android" : d.ios ? "ios" : "pc"
                    })
                }), f = r.encode(new Uint8Array(l.toArrayBuffer()), t.defaultKey);
                o += f.byteLength, s.writeInt32(o).append(f).flip(), this._send(s.toArrayBuffer())
            } catch (c) {
                this.close(), u("WebSocketIO登录失败：登录包发送失败", c)
            }
        }, _processLoginPack: function (e) {
            var n, o = this.config, s = o.password, a = new i(4);
            a.append(e);
            try {
                a = a.slice(4, a.view.byteLength);
                try {
                    n = this._parseAddressBookMessage(r.decode(a.toArrayBuffer(), s).buffer)
                } catch (l) {
                    try {
                        n = this._parseAddressBookMessage(r.decode(a.toArrayBuffer(), o.defaultKey).buffer)
                    } catch (f) {
                        throw new Error("解析消息体异常")
                    }
                }
                if (n.msgid !== p.LoginResp)throw new Error("响应msgid异常，msgid == " + n.msgid);
                if (!this._sn || !n.sn || !n.sn.equals(this._sn))throw new Error("sn验证失败, Message Type: " + t(n.msgid));
                n = n.resp, this._checkResponseError(n), this.session = n.login.session_key, this.emit("login"), this._sendJoinChatroomPack(), this._initHeartBeat()
            } catch (l) {
                this.close(), u("WebSocketIO登录失败", l), this.emit("loginfail")
            }
        }, _checkResponseError: function (e) {
            if (e.error) {
                var t;
                for (var i in c)if (c[i] == e.error.id) {
                    t = i;
                    break
                }
                throw new Error("Error " + (t ? t + "[" + e.error.id + "]" : "Code " + e.error.id))
            }
        }, _sendJoinChatroomPack: function () {
            var e = this, t = this.config, n = 4, o = new i(4), s = new i(t.roomId.length).writeString(t.roomId).flip().toArrayBuffer();
            if (this.session)try {
                var a = this._newAddressBookRequestMessage(p.Service_Req, {
                    service_req: this._newAddressBookMessage("Service_Req", {
                        ...
                        request: this._newChatroomRequestMessage({
                            ...
                            applyjoinchatroomreq: this._newChatroomMessage("ApplyJoinChatRoomRequest", {
                                roomid: s,
                                room: this._newChatroomMessage("ChatRoom", {roomid: s}),
                                userid_type: 0
                            })
                        }).toArrayBuffer()
                    })
                }), l = r.encode(new Uint8Array(a.toArrayBuffer()), this.session);
                n += l.byteLength, o.writeInt32(n).append(l).flip(), this._send(o.toArrayBuffer()), this._joinChatroomTimeout = setTimeout(function () {
                    clearTimeout(e._joinChatroomTimeout), e._joinChatroomTimeout = null, e.emit("joinchatroomfail"), u("加入聊天室失败：响应超时")
                }, this.config.timeout)
            } catch (f) {
                this.emit("joinchatroomfail"), u("加入聊天室失败：加入聊天室包发送失败", f)
            }
        }, _sendQuitChatroomPack: function () {
            var e = this, t = this.config, n = 4, o = new i(4), s = new i(t.roomId.length).writeString(t.roomId).flip().toArrayBuffer();
            if (this.session)try {
                var a = this._newAddressBookRequestMessage(p.Service_Req, {
                    service_req: this._newAddressBookMessage("Service_Req", {
                ...
                n += l.byteLength, o.writeInt32(n).append(l).flip(), this._send(o.toArrayBuffer()), this._quitChatroomTimeout = setTimeout(function () {
                    clearTimeout(e._quitChatroomTimeout), e._quitChatroomTimeout = null, e.emit("quitchatroomfail"), u("退出聊天室失败：响应超时")
                }, this.config.timeout)
            } catch (f) {
                this.emit("quitchatroomfail"), u("退出聊天室失败：退出聊天室包发送失败", f)
            }
        ...
        }, _sendHeartbeatPack: function () {
            var e = this;
            this._send(new i(4).writeInt32(0).buffer), this._heartbeatTimeout = setTimeout(function () {
                clearTimeout(this._heartbeatTimeout), this._heartbeatTimeout = null, e.reconnect()
            }, this.config.timeout)
        }, _processHeartbeatPack: function (e) {
            clearTimeout(this._heartbeatTimeout), this._heartbeatTimeout = null
        }, _processMessagePack: function (e) {
            var t;
            if (!this.session)return u("WebSocketIO处理消息失败：没有登录"), void this.reconnect();
            var n = new i(4);
            if (n.append(e), 4 === n.view.byteLength && 0 === n.readInt32(0))return void this._processHeartbeatPack();
            try {
                n = n.slice(4, n.view.byteLength);
                try {
                    t = this._parseAddressBookMessage(r.decode(n.toArrayBuffer(), this.session).buffer)
                } catch (o) {
                    throw new Error("解析消息体异常")
                }
                var s = this._getMessageHandler(t.msgid);
                s && s.call(this, t)
            } catch (o) {
                u("WebSocketIO处理消息失败", o)
            }
        }, _getMessageHandler: function (e) {
            for (var t in p)if (p[t] == e)return this["_process" + t + "Message"]
        }, _processService_RespMessage: function (e) {
            if (!this._sn || !e.sn || !e.sn.equals(this._sn))throw new Error("sn验证失败, Message Type: " + t(e.msgid));
            var i = this._parseChatroomMessage(e.resp.service_resp.response), r = i.to_user_data;
            if (r.payloadtype === m.applyjoinchatroomresp || r.applyjoinchatroomresp)if (clearTimeout(this._joinChatroomTimeout), this._joinChatroomTimeout = null, r.result === m.successful) {
                var n = parseInt(r.applyjoinchatroomresp.room.properties[1].value.toUTF8(), 10), o = r.applyjoinchatroomresp.room.partnerdata && JSON.parse(r.applyjoinchatroomresp.room.partnerdata.toUTF8()), s = r.applyjoinchatroomresp.room.partnerdata && JSON.parse(r.applyjoinchatroomresp.room.partnerdata.toUTF8())["extends"].watches;
                this.emit("joinchatroom", n, o && o.audiences, s)
            } else this.emit("joinchatroomfail"); else(r.payloadtype === m.quitchatroomresp || r.quitchatroomresp) && (clearTimeout(this._quitChatroomTimeout), this._quitChatroomTimeout = null, r.result === m.successful ? this.emit("quitchatroom") : this.emit("quitchatroomfail"))
        }, _processNewMessageNotifyMessage: function (e) {
            var t, i, r = this._parseChatroomMessage(e.notify.newinfo_ntf.info_content), n = r.to_user_data;
            try {
                if (n && n.result === m.successful)if (n.payloadtype === m.newmsgnotify && n.newmsgnotify)0 === n.newmsgnotify.msgtype && (i = 0 | n.newmsgnotify.memcount, t = n.newmsgnotify.msgcontent, t = t && t.toUTF8(), t = t && JSON.parse(t), t && this.emit("message", t, i)); else if (n.payloadtype === m.memberjoinnotify && n.memberjoinnotify) {
                    try {
                        i = parseInt(n.memberjoinnotify.room.properties[1].value.toUTF8(), 10), t = n.memberjoinnotify.room.members[0].userdata, t = t && t.toUTF8(), t = t && JSON.parse(t)
                    } catch (o) {
                    }
                    this.emit("memberjoin", t, i)
                } else if (n.payloadtype === m.memberquitnotify && n.memberquitnotify) {
                    try {
                        i = parseInt(n.memberquitnotify.room.properties[0].value.toUTF8(), 10), t = n.memberquitnotify.room.members[0].userid, t = t && t.toUTF8()
                    } catch (o) {
                    }
            ...
            this.socket = new WebSocket(this.config.wsServer), this.socket.binaryType = "arraybuffer", this.socket.onopen = this._createSocketHandle("open"), this.socket.onmessage = this._createSocketHandle("message"), this.socket.onclose = this._createSocketHandle("close"), this.socket.onerror = this._createSocketHandle("error")
        }, reconnect: function () {
            this.close(), this.connect()
        }, _clearStatus: function () {
            clearTimeout(this._heartbeatTimeout), clearInterval(this._heartbeatTimer), clearTimeout(this._joinChatroomTimeout), clearTimeout(this._quitChatroomTimeout), this.connected = !1, this.handshake = !1, this.session = null
        }, close: function () {
            this._sendQuitChatroomPack(), this._clearStatus(), this.socket && (this.socket.close(), this.socket = null)
        }, destroy: function () {
            this.destroyed || (this.destroyed = !0, this.close(), this.removeEvent(), this.emit("destroy"))
        }
    }), e.WebSocketIO = g
    ...
    1: [function (e, t, i) {
        t.exports = function () {
            var e = function (e) {
                ...
                var i = arguments[1], r = !0;
                i instanceof Array || (i = t, r = !1);
                var n, o = {};
                for (n in i)attr = r ? i[n] : n, t.hasOwnProperty(attr) && (t[attr] instanceof Array ? o[attr] = cloneArray(t[attr]) : "object" == typeof t[attr] ? o[attr] = cloneOwn(t[attr]) : o[attr] = t[attr]);
                return o
            };
            return {clone_obj: e}
        }()
        ...
        t.exports = function () {
            var t = e("./ajaxTools"), i = "http://g2.live.360.cn/liveplay", r = "http://gtest.live.360.cn/liveplay", n = "http://g2.live.360.cn/replay", o = "http://gtest.live.360.cn/replay", s = 0, a = function (e, l, f) {
                var u = "";
                u = "liveplay" == l.vtype ? l.debug ? r : i : l.debug ? o : n;
                var h = {
                    channel: l.channel,
                    sn: l.sn,
                    _rate: l._rate,
                ...
                t.ajaxJsonp(u, h, function (t) {
                    if (t)f(t), e.trigger("connectSuccess"); else if (e.trigger("reconnect"), 3 > s) {
                        s++;
                        var i = Math.floor(0 + 2 * Math.random());
                        switch (i) {
                            case 0:
                                setTimeout(function () {
                                    a(h, f)
                    ...
                    } else e.trigger("connectError"), f(!1)
                })
            };
            return {init: a}
        }()
    }, {"./ajaxTools": 6}], 3: [function (e, t, i) {
        !function (t) {
            var i = e("./Connect"), r = e("./Video_event"), n = e("./Video_get_attributes"), o = e("./ajaxTools"), s = e("./Clone_obj"), a = e("./event");
            H5_video = function () {
            };
            var l = function (e, t) {
                for (var i in t)e[i] = t[i]
            };
            l(H5_video.prototype, a), H5_video.prototype.init = function (e, t) {
                var r = this;
                t && (this._dom = t), e && (this._user_data = e), this._upload_info_url = "http://qos.live.360.cn/vc.gif", this._event, this._online_timer, this._sdkver = "1.0.0", this._update_info_base_date, this._is_pause = 0, this._stalled_num = 0, this._video, this._is_waiting = 0, this._waiting_start_time = 0, this._waiting_end_time = 0, this._waiting_num = 0, this._is_seek = 0, this._total_waiting_time = 0, this._is_first_error = 1, this._mark_time = 0, this._dispatch_time = 0, this._stalled_time = 0, this._stalled_timer, this._back_url = [], this._update_info_base_date = {
                    ...
                    ver: "0.0.1_device_" + o.getDevice() + "_app_" + o.getApp(),
                ...
                i.init(this, n, function (e) {
                    if (e) {
                        r._back_url = e.back, r._update_info_base_date.u = encodeURI(e.main);
                        var t = r._user_data.width || "100%", i = r._user_data.height || "100%", n = r._user_data.controls ? " controls" : "", a = r._user_data.autoplay ? " autoplay" : "", l = r._user_data.loop ? 'loop="loop"' : "", f = r._user_data.preload ? r._user_data.preload : "auto", u = r._user_data.poster || "", h = "<video " + n + a + ' webkit-playsinline="true" x-webkit-airplay="true" width="' + t + '" height="' + i + '" ' + l + ' preload="' + f + '" poster="' + u + '" src="' + e.main + '" ></video>';
                        r._dom.innerHTML = h, r._video = r._dom.querySelector("video"), r._video.duration = 0, r.add_dispatch_event(), "replay" == r._user_data.vtype && ("pc" == o.getDevice() || o.isAndroidLower()) && o.loadScript("http://s8.qhimg.com/!3736dda8/hls.min.js", function () {
                            if (Hls.isSupported()) {
                                var t = new Hls;
                                t.loadSource(e.main), t.attachMedia(r._video), t.on(Hls.Events.MANIFEST_PARSED, function () {
                                    r._video.play()
                                })
                            }
                        });
                        var d = (new Date).getTime(), p = d - s;
                        r._dispatch_time = p, r.upload_info_action(0, p), r.upload_info_init(), r._online_timer = setInterval(function () {
                            r.upload_info_online(r._upload_info_url, r._update_info_base_date)
                        }, 6e4)
                    } else {
                        alert("cdn 返回链接失败");
                        var d = (new Date).getTime(), p = d - s;
                        r.upload_info_action(r.dom.error.code, p)
                    }
                    r._is_first_error = 0
                })
            }, H5_video.prototype.use_back_url = function () {
                var e = this;
                e._stalled_time = 0, clearInterval(e._stalled_timer), e._video.src = e._dom.querySelector("video").src, e._video.play(), e.trigger("reload current url")
            }, H5_video.prototype.check_video = function () {
                var e = document.createElement("video");
                return e.canPlayType ? !0 : !1
            }, H5_video.prototype.request_full_screen = function () {
                var e = this;
                e._video.requestFullScreen ? (e._video.requestFullScreen(), e.trigger("requestFullScreen")) : e._video.mozRequestFullScreen ? (e._video.mozRequestFullScreen(), e.trigger("requestFullScreen")) : e._video.webkitRequestFullScreen && (e._video.webkitRequestFullScreen(), e.trigger("requestFullScreen"))
            }, H5_video.prototype.cancel_full_screen = function () {
                var e = this;
                e._video.exitFullscreen ? (e._video.exitFullscreen(), e.trigger("cancelFullScreen")) : e._video.mozCancelFullScreen ? (e._video.mozCancelFullScreen(), e.trigger("cancelFullScreen")) : e._video.webkitCancelFullScreen && (e._video.webkitCancelFullScreen(), e.trigger("cancelFullScreen"))
            }, H5_video.prototype.add_dispatch_event = function () {
                var e = this;
                e._event = new r.init(e), e._event.add_event()
                ...
                this._video.play()
            }, H5_video.prototype.remove = function () {
                this.remove_dispatch_event(), this._video.play()
                ...
                var e = arguments[0], t = arguments[1] || 0;
                switch (e) {
                    case"current_time":
                        return n.currentTime(this._video);
                    case"duration":
                        return n.duration(this._video);
                    case"paused":
                        return n.paused(this._video);
                    case"default_playback_rate":
                        return n.defaultPlaybackRate(this._video);
                    case"playback_rate":
                        return n.playbackRate(this._video);
                    case"played_start":
                        return n.played_start(this._video, t);
                    case"played_end":
                        return n.played_end(this._video, t);
                    case"seekable_start":
                        return n.seekable_start(this._video, t);
                    case"seekable_end":
                        return n.seekable_end(this._video, t);
                    case"ended":
                        return n.ended(this._video);
                    case"auto_play":
                        return n.autoPlay(this._video);
                    case"loop":
                        return n.loop(this._video);
                    case"buffered_start":
                        return n.buffered_start(this._video, t);
                    case"buffered_end":
                        return n.buffered_end(this._video, t);
                    case"audioTracks_length":
                        return n.audioTracks_length(this._video);
                    case"audioTracks_get_object_by_id":
                        return n.audioTracks_get_object_by_id(this._video, t);
                    case"audioTracks_get_object_by_index":
                        return n.audioTracks_get_object_by_index(this._video, t);
                    case"controller":
                        return n.controller(this._video);
                    case"current_src":
                        return n.currentSrc(this._video);
                    case"default_muted":
                        return n.defaultMuted(this._video);
                    case"error":
                        return n.error(this._video);
                    case"media_group":
                        return n.mediaGroup(this._video);
                    case"muted":
                        return n.muted(this._video);
                    case"network_state":
                        return n.networkState(this._video);
                    case"ready_state":
                        return n.readyState(this._video);
                    case"volume":
                        return n.volume(this._video);
                    case"textTracks_length":
                        return n.textTracks_length(this._video);
                    case"textTracks_get_object_by_index":
                        return n.textTracks_get_object_by_index(this._video, t);
                    case"textTracks_get_object_by_id":
                        return n.textTracks_get_object_by_id(this._video, t);
                    case"videoTracks_get_object_by_index":
                        return n.videoTracks_get_object_by_index(this._video, t);
                    case"videoTracks_get_object_by_id":
                        return n.videoTracks_get_object_by_id(this._video, t)
                }
            }, H5_video.prototype.upload_info_init = function () {
                var e = this;
                o.ajaxGet(e._upload_info_url, e._update_info_base_date, function (e) {
                    e ? console.log("调度接口请求成功") : console.log("请求调度接口请求失败")
                })
            }, H5_video.prototype.upload_info_action = function (e, t) {
                var i = this, r = s.clone_obj(i._update_info_base_date);
                ...
                o.ajaxGet(i._upload_info_url, r, function (e) {
                    e ? console.log("调度接口上报成功") : console.log("调度接口上报失败")
                })
            }, H5_video.prototype.upload_info_online = function (e, t) {
                var i = s.clone_obj(t);
                i.ty = "online", i.tm = (new Date).getTime(), i.r = Math.random(), o.ajaxGet(e, i, function (e) {
                    e ? console.log("在线接口上报成功") : console.log("在线接口上报失败")
                })
            }, H5_video.prototype.upload_info_exception = function (e) {
                var t = this, i = s.clone_obj(t._update_info_base_date);
                switch (i.exception = e, i.st = 2, i.ty = "action", i.tm = (new Date).getTime(), i.r = Math.random(), i.er = e, e) {
                    case 1:
                        i.em = "第一次加载时用户终止";
                        break;
                    case 2:
                ...
                o.ajaxGet(t._upload_info_url, i, function (e) {
                    e ? console.log("播放过程中的错误接口上报成功") : console.log("播放过程中的错误接口上报失败")
                })
            }, H5_video.prototype.upload_info_buffer = function (e, t) {
                var i = this, r = s.clone_obj(i._update_info_base_date);
                switch (r.br = e, r.ty = "buffer", r.bc = i._waiting_num, r.po = i._video.currentTime, 1 == i._waiting_num ? r.bt = t + i._dispatch_time : r.bt = t, r.tm = (new Date).getTime(), r.r = Math.random(), e) {
                    case 1:
                        r.em = "第一次加载引起的缓冲结束";
                        break;
                    case 2:
                ...
                var i = this, r = s.clone_obj(i._update_info_base_date);
                r.ot = e, r.bc = i._waiting_num, r.pt = t, r.ty = "summary", r.tm = (new Date).getTime(), r.r = Math.random(), o.ajaxGet(i._upload_info_url, r, function (e) {
        ...
        t.exports = function () {
            var e = function (e) {
                function t() {
                    T._obj.trigger("loadstart"), T._obj._is_waiting = 1, T._obj._waiting_start_time = (new Date).getTime()
                }

                function i() {
                    clearInterval(T._obj._stalled_timer), T._obj._stalled_time = 0, T._obj.trigger("progress")
                }
                ...
                function o(e) {
                    if (T._obj.trigger("error"), T._obj._is_first_error) {
                        var t = 0;
                        switch (T._dom.error.code) {
                            case 1:
                                t = 5;
                                break;
                            case 2:
                        ...
                        T._obj.upload_info_exception(t)
                    } else T._obj.upload_info_exception(T._dom.error.code);
                    T._obj._mark_time = T._dom.currentTime, (2 == T._dom.error.code || 3 == T._dom.error.code) && T._obj.use_back_url()
                }

                function s() {
                    clearInterval(T._obj._stalled_timer), T._obj._stalled_time = 0, T._obj.trigger("stalled"), T._obj._mark_time = T._dom.currentTime, T._obj.upload_info_exception(9)
                }

                function a() {
                    if (T._obj._stalled_time++, T._obj._stalled_time >= 9) {
                        var e = T._obj._dom.querySelector("video").getAttribute("src");
                        T._obj._dom.querySelector("video").setAttribute("src", e), T._obj._stalled_time = 0
                    }
                }
                ...
                function f() {
                    T._obj._is_pause = 1, T._obj.trigger("pause")
                }
                ...
                function d() {
                    clearInterval(T._obj._stalled_timer), T._obj._stalled_time = 0, T._obj.trigger("waiting"), T._obj._waiting_num++, T._obj._waiting_start_time = (new Date).getTime(), T._obj._stalled_timer = setInterval(a, 1e3)
                }

                function p() {
                    clearInterval(T._obj._stalled_timer), T._obj._stalled_time = 0, T._obj.trigger("playing"), T._obj._waiting_end_time = (new Date).getTime();
                    var e = T._obj._waiting_end_time - T._obj._waiting_start_time;
                    T._obj._total_waiting_time = T._obj._total_waiting_time + e, T._obj._is_pause ? T._obj._is_pause = 0 : T._obj._is_seek ? 0 != T._obj._waiting_start_time && T._obj.upload_info_buffer(2, e) : 0 == T._obj._waiting_num ? (T._obj._waiting_num++, T._obj.upload_info_buffer(1, e)) : 0 != T._obj._waiting_start_time && T._obj.upload_info_buffer(4, e), T._obj._waiting_start_time = 0, T._obj._waiting_end_time = 0, T._obj._is_seek = 0
                }
                ...
                var T = this;
                T._obj = e, T._dom = e._video, T.add_event = function () {
                    T._dom.addEventListener("loadstart", t, !1), T._dom.addEventListener("progress", i, !1), T._dom.addEventListener("suspend", r, !1), T._dom.addEventListener("abort", n, !1), T._dom.addEventListener("error", o, !1), T._dom.addEventListener("stalled", s, !1), T._dom.addEventListener("play", l, !1), T._dom.addEventListener("pause", f, !1), T._dom.addEventListener("loadedmetadata", u, !1), T._dom.addEventListener("loadeddata", h, !1), T._dom.addEventListener("waiting", d, !1), T._dom.addEventListener("playing", p, !1), T._dom.addEventListener("canplay", c, !1), T._dom.addEventListener("canplaythrough", m, !1), T._dom.addEventListener("seeking", g, !1), T._dom.addEventListener("seeked", y, !1), T._dom.addEventListener("timeupdate", _, !1), T._dom.addEventListener("ended", v, !1), T._dom.addEventListener("ratechange", b, !1), T._dom.addEventListener("durationchange", w, !1), T._dom.addEventListener("volumechange", E, !1)
                }, T.remove_event = function () {
                    T._dom.removeEventListener("loadstart", t, !1), T._dom.removeEventListener("progress", i, !1), T._dom.removeEventListener("suspend", r, !1), T._dom.removeEventListener("abort", n, !1), T._dom.removeEventListener("error", o, !1), T._dom.removeEventListener("stalled", s, !1), T._dom.removeEventListener("play", l, !1), T._dom.removeEventListener("pause", f, !1), T._dom.removeEventListener("loadedmetadata", u, !1), T._dom.removeEventListener("loadeddata", h, !1), T._dom.removeEventListener("waiting", d, !1), T._dom.removeEventListener("playing", p, !1), T._dom.removeEventListener("canplay", c, !1), T._dom.removeEventListener("canplaythrough", m, !1), T._dom.removeEventListener("seeking", g, !1), T._dom.removeEventListener("seeked", y, !1), T._dom.removeEventListener("timeupdate", _, !1), T._dom.removeEventListener("ended", v, !1), T._dom.removeEventListener("ratechange", b, !1), T._dom.removeEventListener("durationchange", w, !1), T._dom.removeEventListener("volumechange", E, !1)
                }
            };
            return {init: e}
        }()
        ...
        t.exports = function () {
            var e = 0, t = 0, i = function (i) {
                return 2 > e ? e++ : 2 == e && (e++, i.currentTime > 1e3 && (t = i.currentTime)), t ? _currentTime = i.currentTime - t : _currentTime = i.currentTime, _currentTime
            }, r = function (e) {
                return e.duration
            }, n = function (e) {
                return e.paused
        ...
        t.exports = function () {
            var e = function () {
                var e = +new Date + "_", t = 0;
                return function () {
                    return e + ++t
                }
            }(), t = function (t, i, r) {
                var n = "Huajiao_player_jsonp" + e();
                window[n] = function (e) {
                    r(e);
                    try {
                        delete window[n]
                ...
                }, i.callback = "window." + n, i._jsonp = i.callback;
                var o = document.createElement("script"), s = document.getElementsByTagName("head")[0];
                o.onreadystatechange = o.onload = function () {
                    (!o.readyState || /loaded|complete/i.test(o.readyState)) && (o.onreadystatechange = o.onload = null, o.parentNode.removeChild(o))
                }, o.onerror = function () {
                    o.onerror = null, o.parentNode.removeChild(o), r(!1)
                }, o.type = "text/javascript", s.appendChild(o);
                var a = "?";
                for (var l in i) {
                    var f = a.indexOf("&");
                    a = -1 == f ? a + l + "=" + encodeURIComponent(i[l]) + "&" : a + l + "=" + encodeURIComponent(i[l]) + "&"
                }
                a = a + "callbackfn=" + n + "&", a = a + "_=" + (new Date).getTime(), o.src = t + a
            }, i = function (e, t, i) {
                var r;
                ...
                for (var o in t) {
                    var s = n.indexOf("&");
                    n = -1 == s ? n + o + "=" + encodeURIComponent(t[o]) + "&" : n + o + "=" + encodeURIComponent(t[o]) + "&"
                }
                n = n + "_=" + (new Date).getTime(), r.withCredentials = !0, r.open("get", e + n, !0), r.send(null), r.onreadystatechange = function (e) {
                    4 == r.readyState && 200 == r.status && i(e ? e : !1)
                }
            }, r = function () {
                var e = navigator.userAgent.toLowerCase();
                return /iphone|ipad|ipod/.test(e) ? "ios" : /android/.test(e) ? "android" : /version/.test(e) && /safari/.test(e) && !/iphone|ipad|ipod/.test(e) ? "pcsafari" : "pc"
            }, n = function () {
                var e = navigator.userAgent.toLowerCase();
                return "micromessenger" == e.match(/MicroMessenger/i) ? "weixin" : "weibo" == e.match(/weibo/i) ? "weibo" : "other"
            }, o = function (e, t) {
                ...
                var e = navigator.userAgent.toLowerCase();
                return e.indexOf("android") > -1 ? e.substr(e.indexOf("android") + 8, 1) < 4 ? !0 : void 0 : !1
            };
            return {ajaxJsonp: t, ajaxGet: i, getDevice: r, getApp: n, loadScript: o, isAndroidLower: s}
        }()
    }, {}], 7: [function (e, t, i) {
        t.exports = function () {
            var e = Array.prototype.slice, t = function () {
                ...
                on: function (e, t, i) {
                    if (!n(this, "on", e, [t, i]) || !t)return this;
                    this._events || (this._events = {});
                    var r = this._events[e] || (this._events[e] = []);
                    return r.push({callback: t, context: i, ctx: i || this}), this
                }, once: function (e, t, i) {
                    if (!n(this, "once", e, [t, i]) || !t)return this;
                    var r = this, o = _.once(function () {
                        r.off(e, o), t.apply(this, arguments)
                    });
                    return o._callback = t, this.on(e, o, i)
                }, off: function (e, t, i) {
                    if (!this._events || !n(this, "off", e, [t, i]))return this;
                    if (!e && !t && !i)return this._events = void 0, this;
                    for (var r = e ? [e] : _.keys(this._events), o = 0, s = r.length; s > o; o++) {
                        e = r[o];
                        var a = this._events[e];
                        if (a)if (t || i) {
                            for (var l = [], f = 0, u = a.length; u > f; f++) {
                                var h = a[f];
                                (t && t !== h.callback && t !== h.callback._callback || i && i !== h.context) && l.push(h)
                            }
                    ...
                    if (!n(this, "trigger", t, i))return this;
                    var r = this._events[t], s = this._events.all;
                    return r && o(r, i), s && o(s, arguments), this
                }, listenTo: function (e, i, r) {
                    var n = this._listeningTo || (this._listeningTo = {}), o = e._listenId || (e._listenId = t("l"));
                    return n[o] = e, r || "object" != typeof i || (r = this), e.on(i, r, this), this
                }, listenToOnce: function (e, t, i) {
                    if ("object" == typeof t) {
                        for (var r in t)this.listenToOnce(e, r, t[r]);
                        return this
                    }
                    var n = _.once(function () {
                        this.stopListening(e, t, n), i.apply(this, arguments)
                    });
                    return n._callback = i, this.listenTo(e, t, n)
                }, stopListening: function (e, t, i) {
                    var r = this._listeningTo;
                    if (!r)return this;
                    var n = !t && !i;
                    i || "object" != typeof t || (i = this), e && ((r = {})[e._listenId] = e);
                    for (var o in r)e = r[o], e.off(t, i, this), (n || _.isEmpty(e._events)) && delete this._listeningTo[o];
                    return this
                }
            }, r = /\s+/, n = function (e, t, i, n) {
                if (!i)return !0;
                if ("object" == typeof i) {
                    for (var o in i)e[t].apply(e, [o, i[o]].concat(n));
                    return !1
                }
                if (r.test(i)) {
                    for (var s = i.split(r), a = 0, l = s.length; l > a; a++)e[t].apply(e, [s[a]].concat(n));
                    return !1
                }
                return !0
            }, o = function (e, t) {
                var i, r = -1, n = e.length, o = t[0], s = t[1], a = t[2];
                switch (t.length) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return;
                    case 2:
                        for (; ++r < n;)(i = e[r]).callback.call(i.ctx, o, s);
                        return;
                    case 3:
                        for (; ++r < n;)(i = e[r]).callback.call(i.ctx, o, s, a);
                        return;
                    default:
    ...
    1: [function (e, t, i) {
        !function (t, i) {
            var r = e("./tools"), n = (e("./template"), e("./skin_liveplay"));
            huajiao_liveplayer = function (e, t, i) {
                function o() {
                }

                if (!e)return r.errorConsole("没有视频地址"), !1;
                if (!t)return r.errorConsole("没有初始化dom"), !1;
                o.prototype = H5_video.prototype;
                var s = new o, a = r.renderLiveplayData(e, i);
                s.init(a, t);
                var l = function () {
                    s.on("urlError", function (e) {
                        console.log("视频地址有误")
                    }), s.on("backUrlError", function (e) {
                        console.log("视频地址有误")
                    }), s.on("connectSuccess", function (e) {
                        n.init(s)
                    }), s.on("play", function (e) {
                        n.hide_icon()
                    }), s.on("pause", function (e) {
                        n.hide_icon(), n.show_pause()
                    }), s.on("waiting", function (e) {
                        n.hide_icon(), n.show_waiting()
                    }), s.on("playing", function (e) {
                        n.set_play(), n.hide_icon()
                    }), s.on("seeking", function (e) {
                        replayer.is_seek = 1
                    }), s.on("seeked", function (e) {
                        setTimeout(function () {
                            replayer.is_seek = 0
                        }, 2e3)
                    }), s.on("timeupdate", function (e) {
                        s.is_seek || (n.update_time(), n.set_play())
                    }), s.on("canplaythrough", function (e) {
                        n.set_total_time(s)
                    }), s.on("durationchange", function (e) {
                        n.update_total_time(s)
                    })
                };
                return s.reconnect = function () {
                    s.use_back_url()
                }, l(), s
            }
        }(jQuery, window)
    }, {"./skin_liveplay": 2, "./template": 3, "./tools": 4}], 2: [function (e, t, i) {
        t.exports = function () {
            var t, i, r, n, o = e("./tools"), s = e("./template"), a = $(".video_wrap"), l = function () {
                ...
                t.hide(), i.hide(), r.hide()
            }, p = function (e) {
                $(".h5_player_control_btn").on("click", function () {
                    n.get_attributes("paused") ? n.play() : n.pause()
                }), r.click(function () {
                    n.get_attributes("paused") ? n.play() : n.pause()
                })
            }, c = function () {
                "ios" == o.getDevice() ? "weixin" == o.getDevice() ? setTimeout(function () {
                    n.get_attributes("current_time") || (d(), r.show(), $(".h5_player_tip_btn").show())
                }, 5e3) : (d(), r.show(), $(".h5_player_tip_btn").show()) : "android" == o.getDevice() ? (d(), r.show(), $(".h5_player_tip_btn").show()) : (d(), r.show(), $(".h5_player_tip_btn").show())
            }, m = function (e) {
                n = e;
                var o = s.liveplay;
                a.append(o), r = $(".h5_player_pause"), t = $(".h5_player_waiting"), i = $(".h5_player_warning"), _tip_wrap = $(".h5_player_tip_btn"), r.css("top", _tip_wrap.height() / 2), t.css("top", _tip_wrap.height() / 2), i.css("top", _tip_wrap.height() / 2), d(), l(), c(), p()
            }, g = function () {
                var e = (parseInt(n.get_attributes("duration")), parseInt(n.get_attributes("current_time"))), t = o.format_time(e);
                $(".h5_player_control_time .now").html(t)
            }, y = function () {
                var e = o.format_time(n.get_attributes("duration"));
        ...
        t.exports = function () {
            var e = function (e) {
                var t = "", i = parseInt(e), r = i % 60, n = parseInt(i / 60), o = 0;
                return n > 60 && (o = parseInt(n / 60), n = parseInt(n % 60)), 10 > n && (n = "0" + n), 10 > r && (r = "0" + r), 10 > o && (o = "0" + o), t = o + ":" + n + ":" + r
            }, t = function (e, t) {
                for (var i in e)t = t.replace("{{" + i + "}}", e[i]);
                return t
            }, i = function () {
                var e = navigator.userAgent.toLowerCase();
                return /iphone|ipad|ipod/.test(e) ? "ios" : /android/.test(e) ? "android" : void 0
            }, r = function () {
                var e = navigator.userAgent.toLowerCase();
                ...
                var e = navigator.userAgent.toLowerCase();
                return e.indexOf("android") > -1 ? 6 == e.substr(e.indexOf("android") + 8, 1) ? !0 : void 0 : !1
            }, s = function () {
                var e = navigator.userAgent.toLowerCase();
                return e.indexOf("android") > -1 ? "5.0" == e.substr(e.indexOf("android") + 8, 3) ? !0 : void 0 : !1
            }, a = function () {
                var e = navigator.userAgent.toLowerCase();
                return e.indexOf("android") > -1 ? "4.4.2" == e.substr(e.indexOf("android") + 8, 5) ? !0 : void 0 : !1
            }, l = function () {
                var e = navigator.userAgent.toLowerCase();
                return e.indexOf("micromessenger/6.3.22") > -1 ? "5.1.1" == e.substr(e.indexOf("android") + 8, 5) ? !0 : !0 : !1
            }, f = function () {
                var e = navigator.userAgent.toLowerCase();
                return e.indexOf("android") > -1 ? "5.1.1" == e.substr(e.indexOf("android") + 8, 5) ? !0 : void 0 : !1
            }, u = function () {
                var e = navigator.userAgent.toLowerCase();
                return e.indexOf("android") > -1 ? "5.1" == e.substr(e.indexOf("android") + 8, 3) ? !0 : void 0 : !1
            }, h = function (e, t) {
                var i = {
                    bid: "huajiao",
                    channel: "huikan_huajiao",
                    sn: e,
                ...
                var n = e.substr(0, 4);
                return "_LC_" == n && (i.channel = "live_huajiao_v2"), i
            }, d = function (e, t) {
                var i = {
                    bid: "huajiao",
