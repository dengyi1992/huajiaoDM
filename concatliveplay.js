!function (e, t) {
    ...
    return e.ZERO = e.fromInt(0), e.UZERO = e.fromInt(0, !0), e.ONE = e.fromInt(1), e.UONE = e.fromInt(1, !0), e.NEG_ONE = e.fromInt(-1), e.MAX_VALUE = e.fromBits(-1, 2147483647, !1), e.MAX_UNSIGNED_VALUE = e.fromBits(-1, -1, !0), e.MIN_VALUE = e.fromBits(0, -2147483648, !1), e.prototype.toInt = function () {
        ...
        var i = this.high >>> 16, r = 65535 & this.high, n = this.low >>> 16, o = 65535 & this.low, s = t.high >>> 16, a = 65535 & t.high, l = t.low >>> 16, f = 65535 & t.low, u = 0, h = 0, p = 0, d = 0;
        return d += o + f, p += d >>> 16, d &= 65535, p += n + l, h += p >>> 16, p &= 65535, h += r + a, u += h >>> 16, h &= 65535, u += i + s, u &= 65535, e.fromBits(p << 16 | d, u << 16 | h, this.unsigned)
        ...
        var i = this.high >>> 16, r = 65535 & this.high, n = this.low >>> 16, o = 65535 & this.low, s = t.high >>> 16, l = 65535 & t.high, f = t.low >>> 16, u = 65535 & t.low, h = 0, p = 0, d = 0, c = 0;
        return c += o * u, d += c >>> 16, c &= 65535, d += n * u, p += d >>> 16, d &= 65535, d += o * f, p += d >>> 16, d &= 65535, p += r * u, h += p >>> 16, p &= 65535, p += n * f, h += p >>> 16, p &= 65535, p += o * l, h += p >>> 16, p &= 65535, h += i * u + r * f + n * l + o * s, h &= 65535, e.fromBits(d << 16 | c, h << 16 | p, this.unsigned)
    ...
    function r(e, t, i, r, n) {
        ...
        for (h += p, o = d & (1 << -u) - 1, d >>= -u, u += a; u > 0; o = 256 * o + e[t + h], h += p, u -= 8);
        for (s = o & (1 << -u) - 1, o >>= -u, u += r; u > 0; s = 256 * s + e[t + h], h += p, u -= 8);
        if (0 === o)o = 1 - f; else {
    ...
    function n(e, t, i, r, n, o) {
        ...
        for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (a = isNaN(t) ? 1 : 0, s = u) : (s = Math.floor(Math.log(t) / Math.LN2), t * (l = Math.pow(2, -s)) < 1 && (s--, l *= 2), t += s + h >= 1 ? p / l : p * Math.pow(2, 1 - h), t * l >= 2 && (s++, l /= 2), s + h >= u ? (a = 0, s = u) : s + h >= 1 ? (a = (t * l - 1) * Math.pow(2, n), s += h) : (a = t * Math.pow(2, h - 1) * Math.pow(2, n), s = 0)); n >= 8; e[i + d] = 255 & a, d += c, a /= 256, n -= 8);
        for (s = s << n | a, f += n; f > 0; e[i + d] = 255 & s, d += c, s /= 256, f -= 8);
        e[i + d - c] |= 128 * m
    }
    ...
    return t.ByteBuffer = e, t.Long = e.Long || null, t.VERSION = "4.0.0", t.WIRE_TYPES = {}, t.WIRE_TYPES.VARINT = 0, t.WIRE_TYPES.BITS64 = 1, t.WIRE_TYPES.LDELIM = 2, t.WIRE_TYPES.STARTGROUP = 3, t.WIRE_TYPES.ENDGROUP = 4, t.WIRE_TYPES.BITS32 = 5, t.PACKABLE_WIRE_TYPES = [t.WIRE_TYPES.VARINT, t.WIRE_TYPES.BITS64, t.WIRE_TYPES.BITS32], t.TYPES = {
        ...
        f.getChildren = function (e) {
            ...
            var t;
            if (t = this.getChild(e.name))if (t instanceof p.Field && t.name !== t.originalName && null === this.getChild(t.originalName))t.name = t.originalName; else {
                if (!(e instanceof p.Field && e.name !== e.originalName && null === this.getChild(e.originalName)))throw Error("Duplicate name in namespace " + this.toString(!0) + ": " + e.name);
        ...
        d.build = function (i) {
            ...
            var r = function (t, i) {
                function r(i, n, o, s, a) {
                    ...
                    if (null === i || "object" != typeof i) {
                        ...
                        var h = i;
                        l = [];
                        for (var p = 0; p < h.length; p++)l.push(r(h[p], n, o, s, a))
                    } else if (i instanceof t.Map) {
                        var d = i.entries();
                        l = {};
                        for (var c = d.next(); !c.done; c = d.next())l[i.keyElem.valueToString(c.value[0])] = r(c.value[1], n, o, i.valueElem.type, i.valueElem.resolvedType)
            ...
            for (var n, o = 0, s = this.children.length; s > o; o++)if (n = this.children[o], n instanceof E || n instanceof p || n instanceof T) {
                ...
                r[n.name] = n.build()
            } else if (n instanceof p.Field)n.build(), this._fields.push(n), this._fieldsById[n.id] = n, this._fieldsByName[n.name] = n; else if (!(n instanceof p.OneOf || n instanceof b))throw Error("Illegal reflect child of " + this.toString(!0) + ": " + this.children[o].toString(!0));
            return this.clazz = r
            ...
            for (var d = 0, c = this._fields.length; c > d; ++d)if (l = this._fields[d], null === u[l.name]) {
                if (l.required) {
        ...
        v.build = function () {
            for (var e = {}, t = this.getChildren(E.Value), i = 0, r = t.length; r > i; ++i)e[t[i].name] = t[i].id;
        ...
        w.prototype = Object.create(s.prototype), o.Enum.Value = w;
        ...
        _.buildOpt = f.buildOpt, o.Service.Method = I;
        var S = function (e, t, i, r, n, o, s, a) {
            I.call(this, e, t, i, a), this.className = "Service.RPCMethod", this.requestName = r, this.responseName = n, this.requestStream = o, this.responseStream = s, this.resolvedRequestType = null, this.resolvedResponseType = null
        };
        return S.prototype = Object.create(I.prototype), o.Service.RPCMethod = S, o
        ...
        return o.reset = function () {
                ...
                for (; t.length > 0;) {
                    ...
                    if (n.isValidMessage(o)) {
                        ...
                        if (o.fields && o.fields.length > 0)for (f = 0, u = o.fields.length; u > f; ++f) {
                            ...
                            if (h.options)for (var p = Object.keys(h.options), d = 0, c = p.length; c > d; ++d) {
                                if ("string" != typeof p[d])throw Error("Illegal field option name in message " + s.name + "#" + h.name + ": " + p[d]);
                                if ("string" != typeof h.options[p[d]] && "number" != typeof h.options[p[d]] && "boolean" != typeof h.options[p[d]])throw Error("Illegal field option value in message " + s.name + "#" + h.name + "#" + p[d] + ": " + h.options[p[d]])
                            }
                            var m = null;
                        ...
                        if (s = this.ptr.resolve(o.ref, !0))for (f = 0; f < o.fields.length; f++) {
                            ...
                            h.extension = E, this.ptr.addChild(E), s.addChild(h)
            ...
            }), t.messages && (this.create(t.messages), this.ptr = p), t.enums && (this.create(t.enums), this.ptr = p), t.services && (this.create(t.services), this.ptr = p), t["extends"] && this.create(t["extends"]), this.reset(), this
...
!function (e) {
    ...
    function l(e, i) {
        ...
        for (r = 0; r < e.length; r += 16)l = p, f = d, u = c, h = m, p = n(p, d, c, m, e[r], 7, -680876936), m = n(m, p, d, c, e[r + 1], 12, -389564586), c = n(c, m, p, d, e[r + 2], 17, 606105819), d = n(d, c, m, p, e[r + 3], 22, -1044525330), p = n(p, d, c, m, e[r + 4], 7, -176418897), m = n(m, p, d, c, e[r + 5], 12, 1200080426), c = n(c, m, p, d, e[r + 6], 17, -1473231341), d = n(d, c, m, p, e[r + 7], 22, -45705983), p = n(p, d, c, m, e[r + 8], 7, 1770035416), m = n(m, p, d, c, e[r + 9], 12, -1958414417), c = n(c, m, p, d, e[r + 10], 17, -42063), d = n(d, c, m, p, e[r + 11], 22, -1990404162), p = n(p, d, c, m, e[r + 12], 7, 1804603682), m = n(m, p, d, c, e[r + 13], 12, -40341101), c = n(c, m, p, d, e[r + 14], 17, -1502002290), d = n(d, c, m, p, e[r + 15], 22, 1236535329), p = o(p, d, c, m, e[r + 1], 5, -165796510), m = o(m, p, d, c, e[r + 6], 9, -1069501632), c = o(c, m, p, d, e[r + 11], 14, 643717713), d = o(d, c, m, p, e[r], 20, -373897302), p = o(p, d, c, m, e[r + 5], 5, -701558691), m = o(m, p, d, c, e[r + 10], 9, 38016083), c = o(c, m, p, d, e[r + 15], 14, -660478335), d = o(d, c, m, p, e[r + 4], 20, -405537848), p = o(p, d, c, m, e[r + 9], 5, 568446438), m = o(m, p, d, c, e[r + 14], 9, -1019803690), c = o(c, m, p, d, e[r + 3], 14, -187363961), d = o(d, c, m, p, e[r + 8], 20, 1163531501), p = o(p, d, c, m, e[r + 13], 5, -1444681467), m = o(m, p, d, c, e[r + 2], 9, -51403784), c = o(c, m, p, d, e[r + 7], 14, 1735328473), d = o(d, c, m, p, e[r + 12], 20, -1926607734), p = s(p, d, c, m, e[r + 5], 4, -378558), m = s(m, p, d, c, e[r + 8], 11, -2022574463), c = s(c, m, p, d, e[r + 11], 16, 1839030562), d = s(d, c, m, p, e[r + 14], 23, -35309556), p = s(p, d, c, m, e[r + 1], 4, -1530992060), m = s(m, p, d, c, e[r + 4], 11, 1272893353), c = s(c, m, p, d, e[r + 7], 16, -155497632), d = s(d, c, m, p, e[r + 10], 23, -1094730640), p = s(p, d, c, m, e[r + 13], 4, 681279174), m = s(m, p, d, c, e[r], 11, -358537222), c = s(c, m, p, d, e[r + 3], 16, -722521979), d = s(d, c, m, p, e[r + 6], 23, 76029189), p = s(p, d, c, m, e[r + 9], 4, -640364487), m = s(m, p, d, c, e[r + 12], 11, -421815835), c = s(c, m, p, d, e[r + 15], 16, 530742520), d = s(d, c, m, p, e[r + 2], 23, -995338651), p = a(p, d, c, m, e[r], 6, -198630844), m = a(m, p, d, c, e[r + 7], 10, 1126891415), c = a(c, m, p, d, e[r + 14], 15, -1416354905), d = a(d, c, m, p, e[r + 5], 21, -57434055), p = a(p, d, c, m, e[r + 12], 6, 1700485571), m = a(m, p, d, c, e[r + 3], 10, -1894986606), c = a(c, m, p, d, e[r + 10], 15, -1051523), d = a(d, c, m, p, e[r + 1], 21, -2054922799), p = a(p, d, c, m, e[r + 8], 6, 1873313359), m = a(m, p, d, c, e[r + 15], 10, -30611744), c = a(c, m, p, d, e[r + 6], 15, -1560198380), d = a(d, c, m, p, e[r + 13], 21, 1309151649), p = a(p, d, c, m, e[r + 4], 6, -145523070), m = a(m, p, d, c, e[r + 11], 10, -1120210379), c = a(c, m, p, d, e[r + 2], 15, 718787259), d = a(d, c, m, p, e[r + 9], 21, -343485551), p = t(p, l), d = t(d, f), c = t(c, u), m = t(m, h);
        return [p, d, c, m]
    }
...
!function (e) {
    ...
    var i = e.dcodeIO.ByteBuffer, r = e.RC4, n = e.Base64, o = e.navigator.userAgent.toLowerCase(), s = ["hasOwnProperty", "valueOf", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "constructor"], a = function () {
        ...
        extend: function (e, t) {
            ...
            var t = "w7h6VMOWbcKqCGA=", i = "wqh+VMKMO8KrCzE=", o = "w7kvUsOXOMO9DGc=", s = "w7IsVcKOPsO+Dmg=", a = "w7IiVcKMO8K+Dzg=", l = "w7I6VMOOOMO9DGc=", f = 1, u = "socket" + (f ? "" : t + i + o + s) + "io", h = e(t), p = e(i), d = e(o), c = e(s), m = e(a), g = e(l);
            return h + p + d + c + (f ? "" : m + g)
    ...
    h.extend(g.prototype, {
        defaultConfig: {
            ...
            var o = this._newAddressBookRequestMessage(d.InitLoginReq, {init_login_req: this._newAddressBookMessage("InitLoginReq", {client_ram: h.randomString(10)})}), s = r.encode(new Uint8Array(o.toArrayBuffer()), e.defaultKey);
            ...
            try {
                ...
                if (n.msgid !== d.InitLoginResp)throw new Error("响应msgid异常，msgid == " + n.msgid);
            ...
            try {
                var l = this._newAddressBookRequestMessage(d.LoginReq, {
                    login: this._newAddressBookMessage("LoginReq", {
                        ...
                        net_type: 4,
                        mobile_type: p.android ? "android" : p.ios ? "ios" : "pc"
                    })
            ...
            try {
                ...
                if (n.msgid !== d.LoginResp)throw new Error("响应msgid异常，msgid == " + n.msgid);
                if (!this._sn || !n.sn || !n.sn.equals(this._sn))throw new Error("sn验证失败, Message Type: " + t(n.msgid));
            ...
            if (this.session)try {
                var a = this._newAddressBookRequestMessage(d.Service_Req, {
            ...
            for (var t in d)if (d[t] == e)return this["_process" + t + "Message"]
...
!function e(t, n, r) {
    ...
    1: [function (e, t, n) {
        t.exports = function () {
            var e = function (e) {
                ...
                var n = arguments[1], r = !0;
                n instanceof Array || (n = t, r = !1);
                var o, i = {};
                for (o in n)attr = r ? n[o] : o, t.hasOwnProperty(attr) && (t[attr] instanceof Array ? i[attr] = cloneArray(t[attr]) : "object" == typeof t[attr] ? i[attr] = cloneOwn(t[attr]) : i[attr] = t[attr]);
                return i
            };
            return {clone_obj: e}
        }()
    ...
    2: [function (e, t, n) {
        t.exports = function () {
            var t = e("./ajaxTools"), n = "http://g2.live.360.cn/liveplay", r = "http://gtest.live.360.cn/liveplay", o = "http://g2.live.360.cn/replay", i = "http://gtest.live.360.cn/replay", a = 0, _ = function (e, s, u) {
                var d = "";
                d = "liveplay" == s.vtype ? s.debug ? r : n : s.debug ? i : o;
                var c = {
                    channel: s.channel,
                    sn: s.sn,
                    _rate: s._rate,
                ...
                t.ajaxJsonp(d, c, function (t) {
                    if (t)u(t), e.trigger("connectSuccess"); else if (e.trigger("reconnect"), 3 > a) {
                        a++;
    ...
    3: [function (e, t, n) {
        !function (t) {
            var n = e("./Connect"), r = e("./Video_event"), o = e("./Video_get_attributes"), i = e("./ajaxTools"), a = e("./Clone_obj"), _ = e("./event");
            H5_video = function () {
            };
            var s = function (e, t) {
                for (var n in t)e[n] = t[n]
            };
            s(H5_video.prototype, _), H5_video.prototype.init = function (e, t) {
                var r = this;
                t && (this._dom = t), e && (this._user_data = e), this._upload_info_url = "http://qos.live.360.cn/vc.gif", this._event, this._online_timer, this._sdkver = "1.0.0", this._update_info_base_date, this._is_pause = 0, this._stalled_num = 0, this._video, this._is_waiting = 0, this._waiting_start_time = 0, this._waiting_end_time = 0, this._waiting_num = 0, this._is_seek = 0, this._total_waiting_time = 0, this._is_first_error = 1, this._mark_time = 0, this._dispatch_time = 0, this._stalled_time = 0, this._stalled_timer, this._back_url = [], this._update_info_base_date = {
                    ...
                    ver: "0.0.1_device_" + i.getDevice() + "_app_" + i.getApp(),
                ...
                n.init(this, o, function (e) {
                    if (e) {
                        r._back_url = e.back, r._update_info_base_date.u = encodeURI(e.main);
                        var t = r._user_data.width || "100%", n = r._user_data.height || "100%", o = r._user_data.controls ? " controls" : "", _ = r._user_data.autoplay ? " autoplay" : "", s = r._user_data.loop ? 'loop="loop"' : "", u = r._user_data.preload ? r._user_data.preload : "auto", d = r._user_data.poster || "", c = "<video " + o + _ + ' webkit-playsinline="true" x-webkit-airplay="true" width="' + t + '" height="' + n + '" ' + s + ' preload="' + u + '" poster="' + d + '" src="' + e.main + '" ></video>';
                        r._dom.innerHTML = c, r._video = r._dom.querySelector("video"), r._video.duration = 0, r.add_dispatch_event(), "replay" == r._user_data.vtype && ("pc" == i.getDevice() || i.isAndroidLower()) && i.loadScript("http://s8.qhimg.com/!3736dda8/hls.min.js", function () {
                            if (Hls.isSupported()) {
                                var t = new Hls;
                        ...
                        var l = (new Date).getTime(), v = l - a;
                        r._dispatch_time = v, r.upload_info_action(0, v), r.upload_info_init(), r._online_timer = setInterval(function () {
                            r.upload_info_online(r._upload_info_url, r._update_info_base_date)
                        }, 6e4)
                    } else {
                        alert("cdn 返回链接失败");
                        var l = (new Date).getTime(), v = l - a;
                        r.upload_info_action(r.dom.error.code, v)
                    }
                    r._is_first_error = 0
                })
                ...
                var e = this;
                i.ajaxGet(e._upload_info_url, e._update_info_base_date, function (e) {
                    e ? console.log("调度接口请求成功") : console.log("请求调度接口请求失败")
                })
            }, H5_video.prototype.upload_info_action = function (e, t) {
                var n = this, r = a.clone_obj(n._update_info_base_date);
                ...
                i.ajaxGet(t._upload_info_url, n, function (e) {
                    e ? console.log("播放过程中的错误接口上报成功") : console.log("播放过程中的错误接口上报失败")
                })
            }, H5_video.prototype.upload_info_buffer = function (e, t) {
                var n = this, r = a.clone_obj(n._update_info_base_date);
                switch (r.br = e, r.ty = "buffer", r.bc = n._waiting_num, r.po = n._video.currentTime, 1 == n._waiting_num ? r.bt = t + n._dispatch_time : r.bt = t, r.tm = (new Date).getTime(), r.r = Math.random(), e) {
                    case 1:
                        r.em = "第一次加载引起的缓冲结束";
                        break;
                    case 2:
                ...
                var n = this, r = a.clone_obj(n._update_info_base_date);
                r.ot = e, r.bc = n._waiting_num, r.pt = t, r.ty = "summary", r.tm = (new Date).getTime(), r.r = Math.random(), i.ajaxGet(n._upload_info_url, r, function (e) {
    ...
    4: [function (e, t, n) {
        t.exports = function () {
            var e = function (e) {
                function t() {
                    w._obj.trigger("loadstart"), w._obj._is_waiting = 1, w._obj._waiting_start_time = (new Date).getTime()
                }

                function n() {
                    clearInterval(w._obj._stalled_timer), w._obj._stalled_time = 0, w._obj.trigger("progress")
                }

                function r() {
                    w._obj.trigger("suspend")
                }

                function o() {
                    w._obj.trigger("abort")
                }

                function i(e) {
                    if (w._obj.trigger("error"), w._obj._is_first_error) {
                        var t = 0;
                        switch (w._dom.error.code) {
                            case 1:
                                t = 5;
                                break;
                            case 2:
                        ...
                        w._obj.upload_info_exception(t)
                    } else w._obj.upload_info_exception(w._dom.error.code);
                    w._obj._mark_time = w._dom.currentTime, (2 == w._dom.error.code || 3 == w._dom.error.code) && w._obj.use_back_url()
                }

                function a() {
                    clearInterval(w._obj._stalled_timer), w._obj._stalled_time = 0, w._obj.trigger("stalled"), w._obj._mark_time = w._dom.currentTime, w._obj.upload_info_exception(9)
                }

                function _() {
                    if (w._obj._stalled_time++, w._obj._stalled_time >= 9) {
                        var e = w._obj._dom.querySelector("video").getAttribute("src");
                        w._obj._dom.querySelector("video").setAttribute("src", e), w._obj._stalled_time = 0
                    }
                }
                ...
                function u() {
                    w._obj._is_pause = 1, w._obj.trigger("pause")
                }

                function d() {
                    w._obj.trigger("loadedmetadata")
                }

                function c() {
                    w._obj.trigger("loadeddata")
                }

                function l() {
                    clearInterval(w._obj._stalled_timer), w._obj._stalled_time = 0, w._obj.trigger("waiting"), w._obj._waiting_num++, w._obj._waiting_start_time = (new Date).getTime(), w._obj._stalled_timer = setInterval(_, 1e3)
                }

                function v() {
                    clearInterval(w._obj._stalled_timer), w._obj._stalled_time = 0, w._obj.trigger("playing"), w._obj._waiting_end_time = (new Date).getTime();
                    var e = w._obj._waiting_end_time - w._obj._waiting_start_time;
                    w._obj._total_waiting_time = w._obj._total_waiting_time + e, w._obj._is_pause ? w._obj._is_pause = 0 : w._obj._is_seek ? 0 != w._obj._waiting_start_time && w._obj.upload_info_buffer(2, e) : 0 == w._obj._waiting_num ? (w._obj._waiting_num++, w._obj.upload_info_buffer(1, e)) : 0 != w._obj._waiting_start_time && w._obj.upload_info_buffer(4, e), w._obj._waiting_start_time = 0, w._obj._waiting_end_time = 0, w._obj._is_seek = 0
                }

                function f() {
                    w._obj.trigger("canplay"), w._obj._mark_time && (w._dom.currentTime = w._obj._mark_time, w._obj._mark_time = 0)
                }

                function p() {
                    w._obj.trigger("canplaythrough")
                }

                function m() {
                    w._obj._is_seek = 1, w._obj.trigger("seeking")
                }

                function h() {
                    w._obj.trigger("seeked")
                }

                function b() {
                    w._obj.trigger("timeupdate")
                }

                function g() {
                    w._obj.upload_info_summary(w._obj._total_waiting_time + w._obj._video.currentTime, w._obj._video.currentTime), w._obj._total_waiting_time = 0, w._obj._waiting_num = 0, clearInterval(w._obj._online_timer), w._obj._is_first_error = 1, w._obj._mark_time = 0, w._obj.trigger("ended")
                }

                function y() {
                    w._obj.trigger("ratechange")
                }

                function j() {
                    w._obj.trigger("durationchange")
                }

                function k() {
                    w._obj.trigger("volumechange")
                }

                var w = this;
                w._obj = e, w._dom = e._video, w.add_event = function () {
                    w._dom.addEventListener("loadstart", t, !1), w._dom.addEventListener("progress", n, !1), w._dom.addEventListener("suspend", r, !1), w._dom.addEventListener("abort", o, !1), w._dom.addEventListener("error", i, !1), w._dom.addEventListener("stalled", a, !1), w._dom.addEventListener("play", s, !1), w._dom.addEventListener("pause", u, !1), w._dom.addEventListener("loadedmetadata", d, !1), w._dom.addEventListener("loadeddata", c, !1), w._dom.addEventListener("waiting", l, !1), w._dom.addEventListener("playing", v, !1), w._dom.addEventListener("canplay", f, !1), w._dom.addEventListener("canplaythrough", p, !1), w._dom.addEventListener("seeking", m, !1), w._dom.addEventListener("seeked", h, !1), w._dom.addEventListener("timeupdate", b, !1), w._dom.addEventListener("ended", g, !1), w._dom.addEventListener("ratechange", y, !1), w._dom.addEventListener("durationchange", j, !1), w._dom.addEventListener("volumechange", k, !1)
                }, w.remove_event = function () {
                    w._dom.removeEventListener("loadstart", t, !1), w._dom.removeEventListener("progress", n, !1), w._dom.removeEventListener("suspend", r, !1), w._dom.removeEventListener("abort", o, !1), w._dom.removeEventListener("error", i, !1), w._dom.removeEventListener("stalled", a, !1), w._dom.removeEventListener("play", s, !1), w._dom.removeEventListener("pause", u, !1), w._dom.removeEventListener("loadedmetadata", d, !1), w._dom.removeEventListener("loadeddata", c, !1), w._dom.removeEventListener("waiting", l, !1), w._dom.removeEventListener("playing", v, !1), w._dom.removeEventListener("canplay", f, !1), w._dom.removeEventListener("canplaythrough", p, !1), w._dom.removeEventListener("seeking", m, !1), w._dom.removeEventListener("seeked", h, !1), w._dom.removeEventListener("timeupdate", b, !1), w._dom.removeEventListener("ended", g, !1), w._dom.removeEventListener("ratechange", y, !1), w._dom.removeEventListener("durationchange", j, !1), w._dom.removeEventListener("volumechange", k, !1)
                }
            };
            return {init: e}
        }()
    ...
    6: [function (e, t, n) {
        t.exports = function () {
            var e = function () {
                ...
                }, n.callback = "window." + o, n._jsonp = n.callback;
                var i = document.createElement("script"), a = document.getElementsByTagName("head")[0];
                i.onreadystatechange = i.onload = function () {
                    (!i.readyState || /loaded|complete/i.test(i.readyState)) && (i.onreadystatechange = i.onload = null, i.parentNode.removeChild(i))
                }, i.onerror = function () {
                    i.onerror = null, i.parentNode.removeChild(i), r(!1)
                }, i.type = "text/javascript", a.appendChild(i);
                var _ = "?";
                for (var s in n) {
                    var u = _.indexOf("&");
                    _ = -1 == u ? _ + s + "=" + encodeURIComponent(n[s]) + "&" : _ + s + "=" + encodeURIComponent(n[s]) + "&"
                }
                _ = _ + "callbackfn=" + o + "&", _ = _ + "_=" + (new Date).getTime(), i.src = t + _
            }, n = function (e, t, n) {
                var r;
                ...
                for (var i in t) {
                    var a = o.indexOf("&");
                    o = -1 == a ? o + i + "=" + encodeURIComponent(t[i]) + "&" : o + i + "=" + encodeURIComponent(t[i]) + "&"
                }
                o = o + "_=" + (new Date).getTime(), r.withCredentials = !0, r.open("get", e + o, !0), r.send(null), r.onreadystatechange = function (e) {
                    4 == r.readyState && 200 == r.status && n(e ? e : !1)
                }
            }, r = function () {
            ...
            return {ajaxJsonp: t, ajaxGet: n, getDevice: r, getApp: o, loadScript: i, isAndroidLower: a}
        }()
    }, {}],
    7: [function (e, t, n) {
        t.exports = function () {
            var e = Array.prototype.slice, t = function () {
                ...
                on: function (e, t, n) {
                    ...
                    for (var r = e ? [e] : _.keys(this._events), i = 0, a = r.length; a > i; i++) {
                        e = r[i];
                        var s = this._events[e];
                        if (s)if (t || n) {
                            for (var u = [], d = 0, c = s.length; c > d; d++) {
                                var l = s[d];
                                (t && t !== l.callback && t !== l.callback._callback || n && n !== l.context) && u.push(l)
                            }
                    ...
                    if (!o(this, "trigger", t, n))return this;
                    var r = this._events[t], a = this._events.all;
                    return r && i(r, n), a && i(a, arguments), this
                }, listenTo: function (e, n, r) {
                    var o = this._listeningTo || (this._listeningTo = {}), i = e._listenId || (e._listenId = t("l"));
                    return o[i] = e, r || "object" != typeof n || (r = this), e.on(n, r, this), this
                    ...
                    var o = _.once(function () {
                        this.stopListening(e, t, o), n.apply(this, arguments)
                    });
                    return o._callback = n, this.listenTo(e, t, o)
                }, stopListening: function (e, t, n) {
                    var r = this._listeningTo;
                    if (!r)return this;
                    var o = !t && !n;
                    n || "object" != typeof t || (n = this), e && ((r = {})[e._listenId] = e);
                    for (var i in r)e = r[i], e.off(t, n, this), (o || _.isEmpty(e._events)) && delete this._listeningTo[i];
                    return this
                }
            }, r = /\s+/, o = function (e, t, n, o) {
                if (!n)return !0;
                if ("object" == typeof n) {
                ...
                if (r.test(n)) {
                    for (var a = n.split(r), _ = 0, s = a.length; s > _; _++)e[t].apply(e, [a[_]].concat(o));
                    return !1
                }
                return !0
            }, i = function (e, t) {
                var n, r = -1, o = e.length, i = t[0], a = t[1], _ = t[2];
                switch (t.length) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return;
                    case 3:
                        for (; ++r < o;)(n = e[r]).callback.call(n.ctx, i, a, _);
                        return;
                    default:
...
!function e(n, s, i) {
    function t(o, a) {
        if (!s[o]) {
            ...
            var p = s[o] = {exports: {}};
            n[o][0].call(p.exports, function (e) {
                var s = n[o][1][e];
                return t(s ? s : e)
            }, p, p.exports, e, n, s, i)
        }
    ...
    for (var r = "function" == typeof require && require, o = 0; o < i.length; o++)t(i[o]);
    return t
}({
    1: [function (e, n, s) {
        !function (n, s) {
            var i = e("./tools"), t = (e("./template"), e("./skin_liveplay"));
            huajiao_liveplayer = function (e, n, s) {
                function r() {
                }

                if (!e)return i.errorConsole("没有视频地址"), !1;
                if (!n)return i.errorConsole("没有初始化dom"), !1;
                r.prototype = H5_video.prototype;
                var o = new r, a = i.renderLiveplayData(e, s);
                o.init(a, n);
                var l = function () {
                    o.on("urlError", function (e) {
                        console.log("视频地址有误")
                    }), o.on("backUrlError", function (e) {
                        console.log("视频地址有误")
                    }), o.on("connectSuccess", function (e) {
                        t.init(o)
                    }), o.on("play", function (e) {
                        t.hide_icon()
                    }), o.on("pause", function (e) {
                        t.hide_icon(), t.show_pause()
                    }), o.on("waiting", function (e) {
                        t.hide_icon(), t.show_waiting()
                    }), o.on("playing", function (e) {
                        t.set_play(), t.hide_icon()
                    }), o.on("seeking", function (e) {
                        replayer.is_seek = 1
                    }), o.on("seeked", function (e) {
                        setTimeout(function () {
                            replayer.is_seek = 0
                        }, 2e3)
                    }), o.on("timeupdate", function (e) {
                        o.is_seek || (t.update_time(), t.set_play())
                    }), o.on("canplaythrough", function (e) {
                        t.set_total_time(o)
                    }), o.on("durationchange", function (e) {
                        t.update_total_time(o)
                    })
                };
                return o.reconnect = function () {
                    o.use_back_url()
                }, l(), o
            }
        }(jQuery, window)
    }, {"./skin_liveplay": 2, "./template": 3, "./tools": 4}], 2: [function (e, n, s) {
        n.exports = function () {
            var n, s, i, t, r = e("./tools"), o = e("./template"), a = $(".video_wrap"), l = function () {
                var e = $(".h5_player_control_btn");
                n.show(), e.addClass("pause"), e.removeClass("play")
            }, c = function () {
                s.show(), i.hide()
            }, p = function () {
                var e = $(".h5_player_control_btn");
                ...
                n.hide(), s.hide(), i.hide()
            }, u = function (e) {
                $(".h5_player_control_btn").on("click", function () {
                    t.get_attributes("paused") ? t.play() : t.pause()
                }), i.click(function () {
                    t.get_attributes("paused") ? t.play() : t.pause()
                })
            }, v = function () {
                "ios" == r.getDevice() ? "weixin" == r.getDevice() ? setTimeout(function () {
                    t.get_attributes("current_time") || (d(), i.show(), $(".h5_player_tip_btn").show())
                }, 5e3) : (d(), i.show(), $(".h5_player_tip_btn").show()) : "android" == r.getDevice() ? (d(), i.show(), $(".h5_player_tip_btn").show()) : (d(), i.show(), $(".h5_player_tip_btn").show())
            }, y = function (e) {
                t = e;
                var r = o.liveplay;
                a.append(r), i = $(".h5_player_pause"), n = $(".h5_player_waiting"), s = $(".h5_player_warning"), _tip_wrap = $(".h5_player_tip_btn"), i.css("top", _tip_wrap.height() / 2), n.css("top", _tip_wrap.height() / 2), s.css("top", _tip_wrap.height() / 2), d(), l(), v(), u()
            }, f = function () {
                var e = (parseInt(t.get_attributes("duration")), parseInt(t.get_attributes("current_time"))), n = r.format_time(e);
                $(".h5_player_control_time .now").html(n)
            }, h = function () {
                var e = r.format_time(t.get_attributes("duration"));
    ...
    }, {"./template": 3, "./tools": 4}], 3: [function (e, n, s) {
        n.exports = function () {
            return {
        ...
        n.exports = function () {
            var e = function (e) {
                var n = "", s = parseInt(e), i = s % 60, t = parseInt(s / 60), r = 0;
                return t > 60 && (r = parseInt(t / 60), t = parseInt(t % 60)), 10 > t && (t = "0" + t), 10 > i && (i = "0" + i), 10 > r && (r = "0" + r), n = r + ":" + t + ":" + i
            }, n = function (e, n) {
                for (var s in e)n = n.replace("{{" + s + "}}", e[s]);
                return n
            }, s = function () {
                var e = navigator.userAgent.toLowerCase();
                ...
                if (n)for (var i in n)s[i] = n[i];
                var t = e.substr(0, 4);
                return "_LC_" == t && (s.channel = "live_huajiao_v2"), s
            }, d = function (e, n) {
                var s = {
                    bid: "huajiao",
