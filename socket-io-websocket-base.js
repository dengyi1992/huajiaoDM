!function (e, t) {
    ...
    return e.ZERO = e.fromInt(0), e.UZERO = e.fromInt(0, !0), e.ONE = e.fromInt(1), e.UONE = e.fromInt(1, !0), e.NEG_ONE = e.fromInt(-1), e.MAX_VALUE = e.fromBits(-1, 2147483647, !1), e.MAX_UNSIGNED_VALUE = e.fromBits(-1, -1, !0), e.MIN_VALUE = e.fromBits(0, -2147483648, !1), e.prototype.toInt = function () {
        ...
        return e.isLong(t) || (t = e.fromValue(t)), this.unsigned !== t.unsigned && this.high >>> 31 === 1 && t.high >>> 31 === 1 ? !1 : this.high === t.high && this.low === t.low
    ...
    var o = function (e, t, i) {
        ...
        this.buffer = 0 === e ? a : new ArrayBuffer(e), this.view = 0 === e ? null : new Uint8Array(this.buffer), this.offset = 0, this.markedOffset = -1, this.limit = e, this.littleEndian = "undefined" != typeof t ? !!t : !1, this.noAssert = !!i
    };
    ...
    return t.ByteBuffer = e, t.Long = e.Long || null, t.VERSION = "4.0.0", t.WIRE_TYPES = {}, t.WIRE_TYPES.VARINT = 0, t.WIRE_TYPES.BITS64 = 1, t.WIRE_TYPES.LDELIM = 2, t.WIRE_TYPES.STARTGROUP = 3, t.WIRE_TYPES.ENDGROUP = 4, t.WIRE_TYPES.BITS32 = 5, t.PACKABLE_WIRE_TYPES = [t.WIRE_TYPES.VARINT, t.WIRE_TYPES.BITS64, t.WIRE_TYPES.BITS32], t.TYPES = {
        ...
        d.build = function (i) {
            ...
            var r = function (t, i) {
                ...
                return Object.defineProperty && (Object.defineProperty(s, "$options", {value: i.buildOpt()}), Object.defineProperty(a, "$options", {value: s.$options}), Object.defineProperty(s, "$type", {value: i}), Object.defineProperty(a, "$type", {value: i})), s
            }(t, this);
...
!function (e) {
    function t(e, t) {
        if (e && t && "object" == typeof t) {
            var i, r, n;
            for (i in t)e[i] = t[i];
            if (h)for (r = h.length; r--;)n = h[r], t.hasOwnProperty(n) && (e[n] = t[n])
        }
        return e
    }
    ...
    function r(e, t) {
        for (var i = [], r = t ? c.slice(0, 10) : c, n = 0; e > n; n++)i.push(r.charAt(Math.floor(Math.random() * r.length)));
        return i.join("")
    }
    ...
    var a = e.dcodeIO.ByteBuffer, l = e.RC4, f = e.Base64, u = e.navigator.userAgent.toLowerCase(), h = ["hasOwnProperty", "valueOf", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "constructor"], p = function () {
    }, d = 0, c = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", m = console && console.log ? function () {
        ...
        }().test(u), android: function () {
            return -1 !== u.indexOf("android") ? /\bandroid[ \/-]?([0-9.x]+)?/ : -1 !== u.indexOf("adr") ? -1 !== u.indexOf("mqqbrowser") ? /\badr[ ]\(linux; u; ([0-9.]+)?/ : /\badr(?:[ ]([0-9.]+))?/ : /\bandroid/
        }().test(u)
    }, y = "w7h6VMOWbcKqCGA=", E = "wqh+VMKMO8KrCzE=", v = "w7kvUsOXOMO9DGc=", w = "w7IsVcKOPsO+Dmg=", b = "w7IiVcKMO8K+Dzg=", T = "w7I6VMOOOMO9DGc=", R = 1, I = "socket" + (R ? "" : y + E + v + w) + "io", _ = function () {
        function e(e) {
            return l.decode(f.decode(e), I)
        }

        var t = e(y), i = e(E), r = e(v), n = e(w), o = e(b), s = e(T);
    ...
    A.defaultConfig = {
        ...
        var n = this;
        if (this.config = t(t({}, this.defaultConfig), i), !this.config.roomId)throw new Error("WebSocketIO初始化失败：缺少roomId");
        this.config.roomId = String(this.config.roomId), this.config.sender = String(this.config.userId) || String(this.config.sender), this.config.sender || (this.config.sender = r(11, !0) + Date.now()), this.config.password || (this.config.password = this.config.sender), e._addressBookProtoBuilder && e._chatroomProtoBuilder ? (this._addressBookProto = e._addressBookProtoBuilder, this._chatroomProto = e._chatroomProtoBuilder) : m("WebSocketIO初始化失败：缺少必要的proto文件"), this.ee = new EventEmitter;
        var o = EventEmitter.prototype;
        for (var s in o)o.hasOwnProperty(s) && !/^_/.test(s) && (this[s] = this._createEventHandle(s));
        ...
        var r = this.config;
        return this._sn = i || n(10), this._newAddressBookMessage("Message", {
            msgid: e,
            sn: this._sn,
            sender: r.sender,
        ...
        var t = this.config, n = new a(t.roomId.length).writeString(t.roomId).flip().toArrayBuffer();
        ...
        i.writeString(e.flag).writeInt8(e.protocolVersion << 4).writeInt8(e.clientVersion).writeInt16(e.appId).writeInt32(0).writeInt16(0), t += i.view.byteLength, t += 4;
        var n = this._newAddressBookRequestMessage(S.InitLoginReq, {init_login_req: this._newAddressBookMessage("InitLoginReq", {client_ram: r(10)})}), o = l.encode(new Uint8Array(n.toArrayBuffer()), e.defaultKey);
        t += o.byteLength, i.writeInt32(t).append(o).flip(), this._send(i.toArrayBuffer())
    }, A._processHandShakePack = function (e) {
        var t, i = this.config, r = new a(6);
        r.append(e);
        try {
            var n = r.readString(2, a.METRICS_CHARS, 0).string;
            if (n !== i.flag)throw new Error("服务器响应标识（flag）有误");
            ...
            if (t.msgid !== S.InitLoginResp)throw new Error("响应msgid异常，msgid == " + t.msgid);
            if (!this._sn || !t.sn || !t.sn.equals(this._sn))throw new Error("sn验证失败, Message Type: " + o(t.msgid));
            this.handshake = !0, this.emit("handshake"), this._sendLoginPack(t.resp)
        } catch (s) {
            this.close(), m("WebSocketIO握手失败", s), this.emit("handshakefail")
        }
    }, A._sendLoginPack = function (e) {
        var t = this.config, i = t.password, n = 4, o = new a(4), f = e.init_login_resp.server_ram;
        try {
            ...
            n += h.byteLength, o.writeInt32(n).append(h).flip(), this._send(o.toArrayBuffer())
        } catch (p) {
            this.close(), m("WebSocketIO登录失败：登录包发送失败", p)
        }
        ...
        try {
            ...
            if (t.msgid !== S.LoginResp)throw new Error("响应msgid异常，msgid == " + t.msgid);
            if (!this._sn || !t.sn || !t.sn.equals(this._sn))throw new Error("sn验证失败, Message Type: " + o(t.msgid));
            t = t.resp, this._checkResponseError(t), this.session = t.login.session_key, this.emit("login"), this._sendJoinChatroomPack(), this._initHeartBeat()
        } catch (s) {
            this.close(), m("WebSocketIO登录失败", s), this.emit("loginfail")
        }
    }, A._checkResponseError = function (e) {
        if (e.error) {
            var t;
            for (var i in P)if (P[i] == e.error.id) {
                t = i;
                break
            }
        ...
        var e = this, t = this.config, i = 4, r = new a(4), n = new a(t.roomId.length).writeString(t.roomId).flip().toArrayBuffer();
        if (this.session)try {
                ...
                service_req: this._newAddressBookMessage("Service_Req", {
                    ...
                    request: this._newChatroomRequestMessage({
                        ...
                        applyjoinchatroomreq: this._newChatroomMessage("ApplyJoinChatRoomRequest", {
                            roomid: n,
                            room: this._newChatroomMessage("ChatRoom", {roomid: n}),
                            userid_type: 0
                        })
                    }).toArrayBuffer()
                })
            }), s = l.encode(new Uint8Array(o.toArrayBuffer()), this.session);
            i += s.byteLength, r.writeInt32(i).append(s).flip(), this._send(r.toArrayBuffer()), this._joinChatroomTimeout = setTimeout(function () {
                clearTimeout(e._joinChatroomTimeout), e._joinChatroomTimeout = null, e.emit("joinchatroomfail"), m("加入聊天室失败：响应超时")
            }, this.config.timeout)
        } catch (f) {
            this.emit("joinchatroomfail"), m("加入聊天室失败：加入聊天室包发送失败", f)
        }
        ...
        if (this.session)try {
            ...
            i += s.byteLength, r.writeInt32(i).append(s).flip(), this._send(r.toArrayBuffer()), this._quitChatroomTimeout = setTimeout(function () {
                clearTimeout(e._quitChatroomTimeout), e._quitChatroomTimeout = null, e.emit("quitchatroomfail"), m("退出聊天室失败：响应超时")
            }, this.config.timeout)
        } catch (f) {
            this.emit("quitchatroomfail"), m("退出聊天室失败：退出聊天室包发送失败", f)
        }
        ...
        var e = this;
        this._send(new a(4).writeInt32(0).buffer), this._heartbeatTimeout = setTimeout(function () {
        ...
        var t;
        if (!this.session)return m("WebSocketIO处理消息失败：没有登录"), void this.reconnect();
        var i = new a(4);
        if (i.append(e), 4 === i.view.byteLength && 0 === i.readInt32(0))return void this._processHeartbeatPack();
        try {
        ...
        for (var t in S)if (S[t] == e)return this["_process" + t + "Message"]
    }, A._processService_RespMessage = function (e) {
        if (!this._sn || !e.sn || !e.sn.equals(this._sn))throw new Error("sn验证失败, Message Type: " + o(e.msgid));
        var t = this._parseChatroomMessage(e.resp.service_resp.response), i = t.to_user_data;
        if (i.payloadtype === L.applyjoinchatroomresp || i.applyjoinchatroomresp)if (clearTimeout(this._joinChatroomTimeout), this._joinChatroomTimeout = null, i.result === L.successful) {
            var r = parseInt(i.applyjoinchatroomresp.room.properties[1].value.toUTF8(), 10), n = i.applyjoinchatroomresp.room.partnerdata && JSON.parse(i.applyjoinchatroomresp.room.partnerdata.toUTF8()), s = i.applyjoinchatroomresp.room.partnerdata && JSON.parse(i.applyjoinchatroomresp.room.partnerdata.toUTF8())["extends"].watches;
            this.emit("joinchatroom", r, n.audiences, s)
        } else this.emit("joinchatroomfail"); else(i.payloadtype === L.quitchatroomresp || i.quitchatroomresp) && (clearTimeout(this._quitChatroomTimeout), this._quitChatroomTimeout = null, i.result === L.successful ? this.emit("quitchatroom") : this.emit("quitchatroomfail"))
        ...
        try {
            if (n && n.result === L.successful)if (n.payloadtype === L.newmsgnotify && n.newmsgnotify)0 === n.newmsgnotify.msgtype && (i = 0 | n.newmsgnotify.memcount, t = n.newmsgnotify.msgcontent, t = t && t.toUTF8(), t = t && JSON.parse(t), t && this.emit("message", t, i)); else if (n.payloadtype === L.memberjoinnotify && n.memberjoinnotify) {
                try {
